...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Dc(e,t,n){let r=new Float32Array(pc),i=new H(0,1,0);return new Zo({name:`SphericalGaussianBlur`,defines:{n:pc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ac(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oc(){return new Zo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ac(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function kc(){return new Zo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ac(),fragmentShader:`
	...
	`}var jc=class extends Jt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
}`,od=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new sa(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Zo({vertexShader:id,fragmentShader:ad,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new G(new Ro(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},sd=class extends tt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new od,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],ee=new V,O=null,k=new ks;k.viewport=new Kt;let te=new ks;te.viewport=new Kt;let A=[k,te],j=new Rs,ne=null,re=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new On,C[e]=t),t.getHandSpace()};function M(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ie(){r.removeEventListener(`select`,M),r.removeEventListener(`selectstart`,M),r.removeEventListener(`selectend`,M),r.removeEventListener(`squeeze`,M),r.removeEventListener(`squeezestart`,M),r.removeEventListener(`squeezeend`,M),r.removeEventListener(`end`,ie),r.removeEventListener(`inputsourceschange`,ae);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}ne=null,re=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,fe.stop(),n.isPresenting=!1,e.setPixelRatio(O),e.setSize(ee.width,ee.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&R(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,M),r.addEventListener(`selectstart`,M),r.addEventListener(`selectend`,M),r.addEventListener(`squeeze`,M),r.addEventListener(`squeezestart`,M),r.addEventListener(`squeezeend`,M),r.addEventListener(`end`,ie),r.addEventListener(`inputsourceschange`,ae),b.xrCompatible!==!0&&await t.makeXRCompatible(),O=e.getPixelRatio(),e.getSize(ee),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new Jt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new aa(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new Jt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),fe.setContext(r),fe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ae(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let oe=new H,se=new H;function ce(e,t,n){oe.setFromMatrixPosition(t.matrixWorld),se.setFromMatrixPosition(n.matrixWorld);let r=oe.distanceTo(se),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function le(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),j.near=te.near=k.near=t,j.far=te.far=k.far=n,(ne!==j.near||re!==j.far)&&(r.updateRenderState({depthNear:j.near,depthFar:j.far}),ne=j.near,re=j.far),j.layers.mask=e.layers.mask|6,k.layers.mask=j.layers.mask&-5,te.layers.mask=j.layers.mask&-3;let i=e.parent,a=j.cameras;le(j,i);for(let e=0;e<a.length;e++)le(a[e],i);a.length===2?ce(j,k,te):j.projectionMatrix.copy(k.projectionMatrix),ue(e,j,i)};function ue(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=at*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return j},this.getFoveation=function(){if(f!==null||p!==null)return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(j)},this.getCameraTexture=function(e){return v[e]};let N=null;function de(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==j.cameras.length&&(j.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=A[n];o===void 0&&(o=new ks,o.layers.enable(n),o.viewport=new Kt,A[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(j.matrix.copy(o.matrix),j.matrix.decompose(j.position,j.quaternion,j.scale)),i===!0&&j.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new sa,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}N&&N(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let fe=new ec;fe.setAnimationLoop(de),this.setAnimationLoop=function(e){N=e},this.dispose=function(){}}},cd=new Zt,ld=new U;ld.set(-1,0,0,0,1,0,0,0,1);function ud(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,qo(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(cd.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(ld),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function dd(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return z(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?R(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):R(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var fd=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),pd=null;function md(){return pd===null&&(pd=new yi(fd,16,16,O,g),pd.name=`DFG_LUT`,pd.minFilter=o,pd.magFilter=o,pd.wrapS=t,pd.wrapT=t,pd.generateMipmaps=!1,pd.needsUpdate=!0),pd}var hd=class{constructor(e={}){let{canvas:t=Je(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([te,k,ee]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new H,O=null,A=null,j=[],ne=[],re=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,ie=!1,ae=null,oe=null,se=null,ce=null;this._outputColorSpace=ze;let le=0,ue=0,N=null,de=-1,fe=null,pe=new Kt,me=new Kt,he=null,ge=new W(0),_e=0,ve=t.width,ye=t.height,be=1,xe=null,Se=null,Ce=new Kt(0,0,ve,ye),we=new Kt(0,0,ve,ye),Te=!1,Ee=new Ii,De=!1,Oe=!1,ke=new Zt,Ae=new H,je=new Kt,Me={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ne=!1;function Pe(){return N===null?be:1}let P=n;function Fe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,ct,!1),t.addEventListener(`webglcontextrestored`,lt,!1),t.addEventListener(`webglcontextcreationerror`,ut,!1),P===null){let t=`webgl2`;if(P=Fe(t,e),P===null)throw Fe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw z(`WebGLRenderer: `+e.message),e}let Ie,Le,F,Re,I,L,Be,Ve,He,Ue,Ge,Ke,qe,Ye,Ze,Qe,et,tt,nt,rt,it,at,ot;function B(){Ie=new Nc(P),Ie.init(),it=new rd(P,Ie),Le=new lc(P,Ie,e,it),F=new td(P,Ie),Le.reversedDepthBuffer&&h&&F.buffers.depth.setReversed(!0),oe=P.createFramebuffer(),se=P.createFramebuffer(),ce=P.createFramebuffer(),Re=new Ic(P),I=new Fu,L=new nd(P,Ie,F,I,Le,it,Re),Be=new Mc(M),Ve=new tc(P),at=new sc(P,Ve),He=new Pc(P,Ve,Re,at),Ue=new Rc(P,He,Ve,at,Re),tt=new Lc(P,Le,L),Ze=new uc(I),Ge=new Pu(M,Be,Ie,Le,at,Ze),Ke=new ud(M,I),qe=new zu,Ye=new Ku(Ie),et=new oc(M,Be,F,Ue,x,s),Qe=new ed(M,Ue,Le),ot=new dd(P,Re,Le,F),nt=new cc(P,Ie,Re),rt=new Fc(P,Ie,Re),Re.programs=Ge.programs,M.capabilities=Le,M.extensions=Ie,M.properties=I,M.renderLists=qe,M.shadowMap=Qe,M.state=F,M.info=Re}B(),S!==1009&&(re=new Bc(S,t.width,t.height,o,r,i));let st=new sd(M,P);this.xr=st,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){let e=Ie.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=Ie.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return be},this.setPixelRatio=function(e){e!==void 0&&(be=e,this.setSize(ve,ye,!1))},this.getSize=function(e){return e.set(ve,ye)},this.setSize=function(e,n,r=!0){if(st.isPresenting){R(`WebGLRenderer: Can't change size while VR device is presenting.`);return}ve=e,ye=n,t.width=Math.floor(e*be),t.height=Math.floor(n*be),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),re!==null&&re.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(ve*be,ye*be).floor()},this.setDrawingBufferSize=function(e,n,r){ve=e,ye=n,be=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){z(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){R(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}re.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(pe)},this.getViewport=function(e){return e.copy(Ce)},this.setViewport=function(e,t,n,r){e.isVector4?Ce.set(e.x,e.y,e.z,e.w):Ce.set(e,t,n,r),F.viewport(pe.copy(Ce).multiplyScalar(be).round())},this.getScissor=function(e){return e.copy(we)},this.setScissor=function(e,t,n,r){e.isVector4?we.set(e.x,e.y,e.z,e.w):we.set(e,t,n,r),F.scissor(me.copy(we).multiplyScalar(be).round())},this.getScissorTest=function(){return Te},this.setScissorTest=function(e){F.setScissorTest(Te=e)},this.setOpaqueSort=function(e){xe=e},this.setTransparentSort=function(e){Se=e},this.getClearColor=function(e){return e.copy(et.getClearColor())},this.setClearColor=function(){et.setClearColor(...arguments)},this.getClearAlpha=function(){return et.getClearAlpha()},this.setClearAlpha=function(){et.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(N!==null){let t=N.texture.format;e=C.has(t)}if(e){let e=N.texture.type,t=w.has(e),n=et.getClearColor(),r=et.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,P.clearBufferuiv(P.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,P.clearBufferiv(P.COLOR,0,E))}else r|=P.COLOR_BUFFER_BIT}t&&(r|=P.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&P.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ae=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,ct,!1),t.removeEventListener(`webglcontextrestored`,lt,!1),t.removeEventListener(`webglcontextcreationerror`,ut,!1),et.dispose(),qe.dispose(),Ye.dispose(),I.dispose(),Be.dispose(),Ue.dispose(),at.dispose(),ot.dispose(),Ge.dispose(),st.dispose(),st.removeEventListener(`sessionstart`,_t),st.removeEventListener(`sessionend`,vt),yt.stop()};function ct(e){e.preventDefault(),Xe(`WebGLRenderer: Context Lost.`),ie=!0}function lt(){Xe(`WebGLRenderer: Context Restored.`),ie=!1;let e=Re.autoReset,t=Qe.enabled,n=Qe.autoUpdate,r=Qe.needsUpdate,i=Qe.type;B(),Re.autoReset=e,Qe.enabled=t,Qe.autoUpdate=n,Qe.needsUpdate=r,Qe.type=i}function ut(e){z(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function dt(e){let t=e.target;t.removeEventListener(`dispose`,dt),ft(t)}function ft(e){pt(e),I.remove(e)}function pt(e){let t=I.get(e).programs;t!==void 0&&(t.forEach(function(e){Ge.releaseProgram(e)}),e.isShaderMaterial&&Ge.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=Me);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ot(e,t,n,r,i);F.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=He.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;at.setup(i,r,s,n,c);let h,g=nt;if(c!==null&&(h=Ve.get(c),g=rt,g.setIndex(h)),i.isMesh)r.wireframe===!0?(F.setLineWidth(r.wireframeLinewidth*Pe()),g.setMode(P.LINES)):g.setMode(P.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),F.setLineWidth(e*Pe()),i.isLineSegments?g.setMode(P.LINES):i.isLineLoop?g.setMode(P.LINE_LOOP):g.setMode(P.LINE_STRIP)}else i.isPoints?g.setMode(P.POINTS):i.isSprite&&g.setMode(P.TRIANGLES);if(i.isBatchedMesh){if(Ie.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Ve.get(c).bytesPerElement:1,o=I.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(P,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function mt(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,Tt(e,t,n),e.side=0,e.needsUpdate=!0,Tt(e,t,n),e.side=2):Tt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),A=Ye.get(n),A.init(t),ne.push(A),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(A.pushLight(e),e.castShadow&&A.pushShadow(e))}),A.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t){if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];mt(a,n,e),r.add(a)}else mt(t,n,e),r.add(t)}}),A=ne.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){I.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}Ie.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ht=null;function gt(e){ht&&ht(e)}function _t(){yt.stop()}function vt(){yt.start()}let yt=new ec;yt.setAnimationLoop(gt),typeof self<`u`&&yt.setContext(self),this.setAnimationLoop=function(e){ht=e,st.setAnimationLoop(e),e===null?yt.stop():yt.start()},st.addEventListener(`sessionstart`,_t),st.addEventListener(`sessionend`,vt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){z(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(ie===!0)return;ae!==null&&ae.renderStart(e,t);let n=st.enabled===!0&&st.isPresenting===!0,r=re!==null&&(N===null||n)&&re.begin(M,N);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),st.enabled===!0&&st.isPresenting===!0&&(re===null||re.isCompositing()===!1)&&(st.cameraAutoUpdate===!0&&st.updateCamera(t),t=st.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,N),A=Ye.get(e,ne.length),A.init(t),A.state.textureUnits=L.getTextureUnits(),ne.push(A),ke.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ee.setFromProjectionMatrix(ke,We,t.reversedDepth),Oe=this.localClippingEnabled,De=Ze.init(this.clippingPlanes,Oe),O=qe.get(e,j.length),O.init(),j.push(O),st.enabled===!0&&st.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&bt(e,t,-1/0,M.sortObjects)}bt(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(xe,Se,t.reversedDepth),Ne=st.enabled===!1||st.isPresenting===!1||st.hasDepthSensing()===!1,Ne&&et.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),De===!0&&Ze.beginShadows();let i=A.state.shadowsArray;if(Qe.render(i,e,t),De===!0&&Ze.endShadows(),(r&&re.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(A.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];St(n,r,e,a)}Ne&&et.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];xt(O,e,n,n.viewport)}}else r.length>0&&St(n,r,e,t),Ne&&et.render(e),xt(O,e,t)}N!==null&&ue===0&&(L.updateMultisampleRenderTarget(N),L.updateRenderTargetMipmap(N)),r&&re.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),at.resetDefaultState(),de=-1,fe=null,ne.pop(),ne.length>0?(A=ne[ne.length-1],L.setTextureUnits(A.state.textureUnits),De===!0&&Ze.setGlobalState(M.clippingPlanes,A.state.camera)):A=null,j.pop(),O=j.length>0?j[j.length-1]:null,ae!==null&&ae.renderEnd()};function bt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)A.pushLightProbeGrid(e);else if(e.isLight)A.pushLight(e),e.castShadow&&A.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ee.intersectsSprite(e)){r&&je.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ke);let t=Ue.update(e),i=e.material;i.visible&&O.push(e,t,i,n,je.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ee.intersectsObject(e))){let t=Ue.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),je.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),je.copy(e.boundingSphere.center)),je.applyMatrix4(e.matrixWorld).applyMatrix4(ke)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,je.z,o)}}else i.visible&&O.push(e,t,i,n,je.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)bt(i[e],t,n,r)}function xt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;A.setupLightsView(n),De===!0&&Ze.setGlobalState(M.clippingPlanes,n),r&&F.viewport(pe.copy(r)),i.length>0&&Ct(i,t,n),a.length>0&&Ct(a,t,n),o.length>0&&Ct(o,t,n),F.buffers.depth.setTest(!0),F.buffers.depth.setMask(!0),F.buffers.color.setMask(!0),F.setPolygonOffset(!1)}function St(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(A.state.transmissionRenderTarget[r.id]===void 0){let e=Ie.has(`EXT_color_buffer_half_float`)||Ie.has(`EXT_color_buffer_float`);A.state.transmissionRenderTarget[r.id]=new Jt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Le.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ft.workingColorSpace})}let a=A.state.transmissionRenderTarget[r.id],o=r.viewport||pe;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),u=M.getActiveCubeFace(),d=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(ge),_e=M.getClearAlpha(),_e<1&&M.setClearColor(16777215,.5),M.clear(),Ne&&et.render(n);let f=M.toneMapping;M.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),A.setupLightsView(r),De===!0&&Ze.setGlobalState(M.clippingPlanes,r),Ct(e,n,r),L.updateMultisampleRenderTarget(a),L.updateRenderTargetMipmap(a),Ie.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,wt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(L.updateMultisampleRenderTarget(a),L.updateRenderTargetMipmap(a))}M.setRenderTarget(s,u,d),M.setClearColor(ge,_e),p!==void 0&&(r.viewport=p),M.toneMapping=f}function Ct(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&wt(o,t,n,s,l,c)}}function wt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function Tt(e,t,n){t.isScene!==!0&&(t=Me);let r=I.get(e),i=A.state.lights,a=A.state.shadowsArray,o=i.state.version,s=Ge.getParameters(e,i.state,a,t,n,A.state.lightProbeGridArray),c=Ge.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Be.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,dt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return Dt(e,s),d}else s.uniforms=Ge.getUniforms(e),ae!==null&&e.isNodeMaterial&&ae.build(e,n,s),e.onBeforeCompile(s,M),d=Ge.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=Ze.uniform),Dt(e,s),r.needsLights=At(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=A.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function Et(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=ql.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function Dt(e,t){let n=I.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function V(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ot(e,t,n,r,i){t.isScene!==!0&&(t=Me),L.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=N===null?M.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Ft.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Be.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=I.get(r),y=A.state.lights;if(De===!0&&(Oe===!0||e!==fe)){let t=e===fe&&r.id===de;Ze.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==Ze.numPlanes||v.numIntersection!==Ze.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=A.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=Tt(r,t,i),ae&&r.isNodeMaterial&&ae.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(F.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==de&&(de=r.id,C=!0),v.needsLights){let e=V(A.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||fe!==e){F.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(P,`projectionMatrix`,e.projectionMatrix),T.setValue(P,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(P,Ae.setFromMatrixPosition(e.matrixWorld)),Le.logarithmicDepthBuffer&&T.setValue(P,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(P,`isOrthographic`,e.isOrthographicCamera===!0),fe!==e&&(fe=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(P,`directionalShadowMap`,y.state.directionalShadowMap,L),y.state.spotShadowMap.length>0&&T.setValue(P,`spotShadowMap`,y.state.spotShadowMap,L),y.state.pointShadowMap.length>0&&T.setValue(P,`pointShadowMap`,y.state.pointShadowMap,L)),i.isSkinnedMesh){T.setOptional(P,i,`bindMatrix`),T.setOptional(P,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(P,`boneTexture`,e.boneTexture,L))}i.isBatchedMesh&&(T.setOptional(P,i,`batchingTexture`),T.setValue(P,`batchingTexture`,i._matricesTexture,L),T.setOptional(P,i,`batchingIdTexture`),T.setValue(P,`batchingIdTexture`,i._indirectTexture,L),T.setOptional(P,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(P,`batchingColorTexture`,i._colorsTexture,L));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&tt.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(P,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=md()),C){if(T.setValue(P,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&kt(E,w),a&&r.fog===!0&&Ke.refreshFogUniforms(E,a),Ke.refreshMaterialUniforms(E,r,be,ye,A.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}ql.upload(P,Et(v),E,L)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(ql.upload(P,Et(v),E,L),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(P,`center`,i.center),T.setValue(P,`modelViewMatrix`,i.modelViewMatrix),T.setValue(P,`normalMatrix`,i.normalMatrix),T.setValue(P,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];ot.update(n,x),ot.bind(n,x)}}return x}function kt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function At(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return le},this.getActiveMipmapLevel=function(){return ue},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(e,t,n){let r=I.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),I.get(e.texture).__webglTexture=t,I.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=I.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){N=e,le=t,ue=n;let r=null,i=!1,a=!1;if(e){let o=I.get(e);if(o.__useDefaultFramebuffer!==void 0){F.bindFramebuffer(P.FRAMEBUFFER,o.__webglFramebuffer),pe.copy(e.viewport),me.copy(e.scissor),he=e.scissorTest,F.viewport(pe),F.scissor(me),F.setScissorTest(he),de=-1;return}if(o.__webglFramebuffer===void 0)L.setupRenderTarget(e);else if(o.__hasExternalTextures)L.rebindTextures(e,I.get(e.texture).__webglTexture,I.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&I.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);L.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=I.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&L.useMultisampledRTT(e)===!1?I.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,pe.copy(e.viewport),me.copy(e.scissor),he=e.scissorTest}else pe.copy(Ce).multiplyScalar(be).floor(),me.copy(we).multiplyScalar(be).floor(),he=Te;if(n!==0&&(r=oe),F.bindFramebuffer(P.FRAMEBUFFER,r)&&F.drawBuffers(e,r),F.viewport(pe),F.scissor(me),F.setScissorTest(he),i){let r=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=I.get(e.textures[t]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=I.get(e.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,t.__webglTexture,n)}de=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){F.bindFramebuffer(P.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Le.textureFormatReadable(c)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Le.textureTypeReadable(l)){z(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&P.readPixels(t,n,r,i,it.convert(c),it.convert(l),a)}finally{let e=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=I.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){F.bindFramebuffer(P.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+s),!Le.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Le.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.bufferData(P.PIXEL_PACK_BUFFER,a.byteLength,P.STREAM_READ),P.readPixels(t,n,r,i,it.convert(l),it.convert(u),0);let f=N===null?null:I.get(N).__webglFramebuffer;F.bindFramebuffer(P.FRAMEBUFFER,f);let p=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await $e(P,p,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,d),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,a),P.deleteBuffer(d),P.deleteSync(p),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;L.setTexture2D(e,0),P.copyTexSubImage2D(P.TEXTURE_2D,n,0,0,o,s,i,a),F.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=it.convert(t.format),_=it.convert(t.type),v;t.isData3DTexture?(L.setTexture3D(t,0),v=P.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(L.setTexture2DArray(t,0),v=P.TEXTURE_2D_ARRAY):(L.setTexture2D(t,0),v=P.TEXTURE_2D),F.activeTexture(P.TEXTURE0),F.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,t.flipY),F.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),F.pixelStorei(P.UNPACK_ALIGNMENT,t.unpackAlignment);let y=F.getParameter(P.UNPACK_ROW_LENGTH),b=F.getParameter(P.UNPACK_IMAGE_HEIGHT),x=F.getParameter(P.UNPACK_SKIP_PIXELS),S=F.getParameter(P.UNPACK_SKIP_ROWS),C=F.getParameter(P.UNPACK_SKIP_IMAGES);F.pixelStorei(P.UNPACK_ROW_LENGTH,h.width),F.pixelStorei(P.UNPACK_IMAGE_HEIGHT,h.height),F.pixelStorei(P.UNPACK_SKIP_PIXELS,l),F.pixelStorei(P.UNPACK_SKIP_ROWS,u),F.pixelStorei(P.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=I.get(e),r=I.get(t),h=I.get(n.__renderTarget),g=I.get(r.__renderTarget);F.bindFramebuffer(P.READ_FRAMEBUFFER,h.__webglFramebuffer),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(e).__webglTexture,i,d+n),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,I.get(t).__webglTexture,a,m+n)),P.blitFramebuffer(l,u,o,s,f,p,o,s,P.DEPTH_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||I.has(e)){let n=I.get(e),r=I.get(t);F.bindFramebuffer(P.READ_FRAMEBUFFER,se),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,ce);for(let e=0;e<c;e++)w?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,n.__webglTexture,i),T?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,r.__webglTexture,a),i===0?T?P.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):P.copyTexSubImage2D(v,a,f,p,l,u,o,s):P.blitFramebuffer(l,u,o,s,f,p,o,s,P.COLOR_BUFFER_BIT,P.NEAREST);F.bindFramebuffer(P.READ_FRAMEBUFFER,null),F.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?P.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):P.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):P.texSubImage2D(P.TEXTURE_2D,a,f,p,o,s,g,_,h);F.pixelStorei(P.UNPACK_ROW_LENGTH,y),F.pixelStorei(P.UNPACK_IMAGE_HEIGHT,b),F.pixelStorei(P.UNPACK_SKIP_PIXELS,x),F.pixelStorei(P.UNPACK_SKIP_ROWS,S),F.pixelStorei(P.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&P.generateMipmap(v),F.unbindTexture()},this.initRenderTarget=function(e){I.get(e).__webglFramebuffer===void 0&&L.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?L.setTextureCube(e,0):e.isData3DTexture?L.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?L.setTexture2DArray(e,0):L.setTexture2D(e,0),F.unbindTexture()},this.resetState=function(){le=0,ue=0,N=null,F.reset(),at.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return We}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Ft._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ft._getUnpackColorSpace()}},gd={LENGTH:2.74,WIDTH:1.525,HEIGHT:.76,THICKNESS:.05,NET_HEIGHT:.1525,NET_OVERHANG:.14},J=gd.HEIGHT,_d=gd.HEIGHT+gd.NET_HEIGHT,vd=8.2,yd=.034,bd=.86,xd=.985,Sd=.12,Cd=.82,wd=1.62,Td=.2,Ed=.3,Dd={easy:{botSpeed:1.7,botErr:.34,botReact:.32,botPower:[3,4.1],missProb:.28,reach:.34,hitRadius:.68,assist:.55},medium:{botSpeed:2.6,botErr:.22,botReact:.2,botPower:[3.6,4.9],missProb:.15,reach:.4,hitRadius:.58,assist:.35},hard:{botSpeed:4,botErr:.12,botReact:.1,botPower:[4.2,6],missProb:.06,reach:.47,hitRadius:.48,assist:.18}},Y={mode:`classic`,scale:1,seats:2,halfW:gd.WIDTH/2,halfL:gd.LENGTH/2,apothem:1,edgeHalf:gd.WIDTH/2,playerZ:1.62,robotDist:1.62,camZ:2.42,camY:1.52,playerXRange:1.18,hasNet:!0,nets:[],speedScale:1,seatDirs:[],seatTans:[],surface:{holes:[],bumps:[],ice:!1},configure({mode:e=`classic`,scale:t=1}={}){if(this.mode=e,this.scale=t,this.surface={holes:[],bumps:[],ice:!1},e===`classic`){this.seats=2,this.halfW=gd.WIDTH/2*t,this.halfL=gd.LENGTH/2*t,this.edgeHalf=this.halfW,this.playerZ=this.halfL+.26,this.robotDist=this.halfL+.26,this.camZ=this.halfL+1.06,this.camY=1.52+Math.max(0,t-1)*.45,this.playerXRange=Math.max(1.18,this.halfW+.42),this.hasNet=!0,this.speedScale=(this.halfL/1.37)**.8,this.seatDirs=[new V(0,1),new V(0,-1)],this.seatTans=[new V(1,0),new V(-1,0)];let e=this.halfW+.16;this.nets=[{ax:-e,az:0,bx:e,bz:0,nx:0,nz:1}]}else{this.seats=3,this.apothem=1.05*t,this.edgeHalf=this.apothem*Math.tan(Math.PI/6),this.playerZ=this.apothem+.26,this.robotDist=this.apothem+.26,this.camZ=this.apothem+1.08,this.camY=1.54+Math.max(0,t-1)*.45,this.playerXRange=Math.max(1.15,this.edgeHalf+.5),this.hasNet=!0,this.speedScale=.9*t**.8,this.seatDirs=[],this.seatTans=[];for(let e=0;e<3;e++){let t=e*Math.PI*2/3;this.seatDirs.push(new V(Math.sin(t),Math.cos(t))),this.seatTans.push(new V(Math.cos(t),-Math.sin(t)))}this.boundNormals=[];for(let e=0;e<6;e++){let t=e*Math.PI/3;this.boundNormals.push(new V(Math.sin(t),Math.cos(t)))}this.nets=[];for(let e=0;e<3;e++){let t=Dt.degToRad(60+120*e),n=Math.sin(t),r=Math.cos(t);this.nets.push({ax:0,az:0,bx:n*this.apothem,bz:r*this.apothem,nx:Math.cos(t),nz:-Math.sin(t)})}}},containsPoint(e,t){if(this.mode===`classic`)return Math.abs(e)<=this.halfW+.01&&Math.abs(t)<=this.halfL+.01;for(let n of this.boundNormals)if(e*n.x+t*n.y>this.apothem+.01)return!1;return!0},sectorOf(e,t){if(this.mode===`classic`)return t>=0?0:1;let n=0,r=-1/0;for(let i=0;i<3;i++){let a=this.seatDirs[i],o=e*a.x+t*a.y;o>r&&(r=o,n=i)}return n},randomPointOnTable(e=.85){if(this.mode===`classic`)return{x:(Math.random()*2-1)*this.halfW*e,z:(Math.random()*2-1)*this.halfL*e};for(let t=0;t<40;t++){let t=(Math.random()*2-1)*this.apothem*1.2,n=(Math.random()*2-1)*this.apothem*1.2,r=!0;for(let i of this.boundNormals)if(t*i.x+n*i.y>this.apothem*e){r=!1;break}if(r)return{x:t,z:n}}return{x:0,z:0}},sectorTarget(e,t,n){if(this.mode===`classic`){let r=this.seatDirs[e];return{x:n*this.halfW*.78,y:J,z:r.y*this.halfL*(.3+.58*t)}}let r=this.seatDirs[e],i=this.seatTans[e];for(let a=0;a<8;a++){let a=this.apothem*(.28+.52*t),o=n*this.apothem*.55,s=r.x*a+i.x*o,c=r.y*a+i.y*o;if(this.containsPoint(s,c)&&this.sectorOf(s,c)===e)return{x:s,y:J,z:c};n*=.6}return{x:r.x*this.apothem*.5,y:J,z:r.y*this.apothem*.5}},distToNets(e,t){let n=1/0;for(let r of this.nets){let i=r.bx-r.ax,a=r.bz-r.az,o=i*i+a*a,s=((e-r.ax)*i+(t-r.az)*a)/o;s=Math.max(0,Math.min(1,s)),n=Math.min(n,Math.hypot(e-(r.ax+i*s),t-(r.az+a*s)))}return n},surfaceAt(e,t){for(let n of this.surface.holes){let r=e-n.x,i=t-n.z;if(r*r+i*i<n.r*n.r)return{hole:!0}}let n=0,r=0;for(let i of this.surface.bumps){let a=e-i.x,o=t-i.z,s=a*a+o*o,c=i.r*i.r;if(s<c*4){let e=Math.sqrt(s)+1e-6,t=Math.exp(-s/c)*i.h*9;n+=a/e*t,r+=o/e*t}}return n||r?{normal:new H(n,1,r).normalize(),ice:this.surface.ice}:{ice:this.surface.ice}}};Y.configure({});var Od=null,kd=null,Ad=null,jd=new $o({color:1065359,roughness:.35,metalness:.1}),Md=new ai({color:16777215}),Nd=new $o({color:3159615,roughness:.6,metalness:.5}),Pd=new $o({color:3356740,roughness:.4,metalness:.6});function Fd(e){e.traverse(e=>{e.geometry&&e.geometry.dispose();let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)e&&e!==jd&&e!==Md&&e!==Nd&&e!==Pd&&e.dispose?.()})}var Id={init(e){Od=e},get group(){return kd},rebuild(){kd&&(Fd(kd),Od.remove(kd)),kd=new En,Y.mode===`classic`?Vd():Hd(),Od.add(kd)},addHoleDecal(e,t,n,r=`meteor`){let i=document.createElement(`canvas`);i.width=i.height=128;let a=i.getContext(`2d`);a.translate(64,64),a.beginPath();let o=[];for(let e=0;e<=18;e++){let t=e/18*Math.PI*2,n=e===18?o[0]:46+Math.random()*14;o.push(n);let r=Math.cos(t)*n,i=Math.sin(t)*n;e===0?a.moveTo(r,i):a.lineTo(r,i)}a.closePath(),r===`meteor`?(a.strokeStyle=`rgba(255,120,30,0.95)`,a.lineWidth=7,a.stroke()):(a.strokeStyle=`rgba(240,240,255,0.5)`,a.lineWidth=4,a.stroke()),a.fillStyle=`#050508`,a.fill();let s=new ia(i);s.colorSpace=ze;let c=new G(new Ro(n*2.2,n*2.2),new ai({map:s,transparent:!0,depthWrite:!1}));c.rotation.x=-Math.PI/2,c.rotation.z=Math.random()*Math.PI*2,c.position.set(e,J+.003,t),kd.add(c)},setSnow(){if(Ad){let e=Ad();e.material=new $o({color:16054527,transparent:!0,opacity:.45,roughness:.9}),kd.add(e)}let e=new G(new ua(26,40),new $o({color:16054527,transparent:!0,opacity:.55,roughness:.95}));e.rotation.x=-Math.PI/2,e.position.y=.012,kd.add(e)}},Ld={tape:null,plain:null};function Rd(e){let t=e?`tape`:`plain`;if(Ld[t])return Ld[t];let n=document.createElement(`canvas`);n.width=256,n.height=32;let r=n.getContext(`2d`);r.fillStyle=`rgba(40,50,70,0.30)`,r.fillRect(0,0,256,32),r.strokeStyle=`rgba(30,38,55,0.9)`,r.lineWidth=1;for(let e=0;e<=64;e++)r.beginPath(),r.moveTo(e*4,0),r.lineTo(e*4,32),r.stroke();for(let e=0;e<=8;e++)r.beginPath(),r.moveTo(0,e*4),r.lineTo(256,e*4),r.stroke();e&&(r.fillStyle=`#fff`,r.fillRect(0,0,256,3));let i=new ia(n);return i.colorSpace=ze,Ld[t]=i,i}function zd(e,t=!0){return new G(new Ro(e,gd.NET_HEIGHT),new ai({map:Rd(t),transparent:!0,side:2,depthWrite:!1}))}function Bd(e){for(let[t,n]of e){let e=new G(new ca(.06,J-gd.THICKNESS,.06),Nd);e.position.set(t,(J-gd.THICKNESS)/2,n),e.castShadow=!0,kd.add(e)}}function Vd(){let e=Y.halfW*2,t=Y.halfL*2,n=new G(new ca(e,gd.THICKNESS,t),jd);n.position.y=J-gd.THICKNESS/2,n.castShadow=!0,n.receiveShadow=!0,kd.add(n),Ad=()=>{let n=new G(new Ro(e,t));return n.rotation.x=-Math.PI/2,n.position.y=J+.0015,n};let r=J+.001,i=(e,t,n,i)=>{let a=new G(new Ro(e,t),Md);a.rotation.x=-Math.PI/2,a.position.set(n,r,i),kd.add(a)},a=.02;i(a,t,-Y.halfW+a/2,0),i(a,t,Y.halfW-a/2,0),i(e,a,0,-Y.halfL+a/2),i(e,a,0,Y.halfL-a/2),i(.006,t,0,0),Bd([[-(Y.halfW-.14),Y.halfL-.22],[Y.halfW-.14,Y.halfL-.22],[-(Y.halfW-.14),-(Y.halfL-.22)],[Y.halfW-.14,-(Y.halfL-.22)]]);let o=e+gd.NET_OVERHANG*2,s=zd(o);s.position.set(0,J+gd.NET_HEIGHT/2,0),kd.add(s);for(let e of[-1,1]){let t=new G(new da(.012,.012,gd.NET_HEIGHT+.03,8),Pd);t.position.set(e*o/2,J+(gd.NET_HEIGHT+.03)/2,0),kd.add(t)}}function Hd(){let e=Y.apothem,t=e/Math.cos(Math.PI/6),n=[];for(let e=0;e<6;e++){let r=Dt.degToRad(30+60*e);n.push([Math.sin(r)*t,Math.cos(r)*t])}let r=new Ya;r.moveTo(n[0][0],-n[0][1]);for(let e=1;e<6;e++)r.lineTo(n[e][0],-n[e][1]);r.closePath();let i=new Po(r,{depth:gd.THICKNESS,bevelEnabled:!1});i.rotateX(-Math.PI/2);let a=new G(i,jd);a.position.y=J-gd.THICKNESS,a.castShadow=!0,a.receiveShadow=!0,kd.add(a),Ad=()=>{let e=new zo(r);e.rotateX(-Math.PI/2);let t=new G(e);return t.position.y=J+.0015,t};let o=J+.001;for(let e=0;e<6;e++){let[t,r]=n[e],[i,a]=n[(e+1)%6],s=new G(new Ro(.022,Math.hypot(i-t,a-r)-.02),Md);s.rotation.x=-Math.PI/2,s.rotation.z=Math.atan2(i-t,a-r),s.position.set((t+i)/2,o,(r+a)/2),kd.add(s)}let s=J+gd.NET_HEIGHT/2;for(let t=0;t<3;t++){let n=Dt.degToRad(60+120*t),r=Math.sin(n)*e,i=Math.cos(n)*e,a=zd(e,!1);a.rotation.y=Math.atan2(-i,r),a.position.set(r/2,s,i/2),kd.add(a);let o=new G(new da(.012,.012,gd.NET_HEIGHT+.03,8),Pd);o.position.set(r,J+(gd.NET_HEIGHT+.03)/2,i),kd.add(o)}let c=new G(new da(.016,.016,gd.NET_HEIGHT+.04,10),Pd);c.position.y=J+(gd.NET_HEIGHT+.04)/2,kd.add(c),Bd(n.map(([e,t])=>[e*.72,t*.72]))}function Ud(e){let t=new hd({antialias:!0,powerPreference:`high-performance`});return t.setPixelRatio(Math.min(window.devicePixelRatio,2)),t.setSize(window.innerWidth,window.innerHeight),t.shadowMap.enabled=!0,t.shadowMap.type=2,t.toneMapping=4,t.toneMappingExposure=1.05,e.appendChild(t.domElement),t}function Wd(){let e=new ks(62,window.innerWidth/window.innerHeight,.05,120);return e.position.set(0,1.52,2.42),e.lookAt(0,J+.1,-1.2),e}function Gd(){let e=new Fn;e.fog=new Pn(13625077,18,55);let t=document.createElement(`canvas`);t.width=4,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#3f8fd4`),r.addColorStop(.45,`#7dbde8`),r.addColorStop(.75,`#cfe9f7`),r.addColorStop(1,`#e8f4e2`),n.fillStyle=r,n.fillRect(0,0,4,256);let i=new ia(t);i.colorSpace=ze;let a=new G(new Vo(60,24,16),new ai({map:i,side:1,fog:!1}));e.add(a);let o=new G(new ua(2.6,24),new ai({color:16774872,fog:!1}));o.position.set(22,30,-38),o.lookAt(0,1,0),e.add(o),e.add(new _s(12574975,4880954,.85));let s=new Ps(16773849,2.4);s.position.set(6,9,-6),s.castShadow=!0,s.shadow.mapSize.set(1024,1024),s.shadow.camera.left=-3,s.shadow.camera.right=3,s.shadow.camera.top=4,s.shadow.camera.bottom=-3,s.shadow.camera.near=2,s.shadow.camera.far=25,s.shadow.bias=-.0015,e.add(s);let c=new Ps(14085119,.7);return c.position.set(-2,2.2,7),e.add(c),Kd(e),e}function Kd(t){let n=document.createElement(`canvas`);n.width=n.height=256;let r=n.getContext(`2d`);r.fillStyle=`#4d8f3c`,r.fillRect(0,0,256,256);for(let e=0;e<3800;e++){let e=60+Math.random()*90;r.fillStyle=`rgba(${30+Math.random()*40}, ${e+40}, ${25+Math.random()*30}, 0.5)`;let t=Math.random()*256,n=Math.random()*256;r.fillRect(t,n,1.5+Math.random()*2,2+Math.random()*4)}let i=new ia(n);i.colorSpace=ze,i.wrapS=i.wrapT=e,i.repeat.set(24,24);let a=new G(new Ro(120,120),new $o({map:i,roughness:.95,metalness:0}));a.rotation.x=-Math.PI/2,a.receiveShadow=!0,t.add(a);let o=new G(new Ro(5.4,7.6),new $o({color:10135706,roughness:.9}));o.rotation.x=-Math.PI/2,o.position.y=.005,o.receiveShadow=!0,t.add(o);let s=new ai({color:16120048}),c=(e,n,r,i)=>{let a=new G(new Ro(e,n),s);a.rotation.x=-Math.PI/2,a.position.set(r,.008,i),t.add(a)};c(.07,7.6,-2.7,0),c(.07,7.6,2.7,0),c(5.4,.07,0,-3.8),c(5.4,.07,0,3.8);let l=new Lo(1,1),u=new $o({color:3042090,roughness:.9,flatShading:!0}),d=new $o({color:4165432,roughness:.9,flatShading:!0}),f=new Oi(l,u,34),p=new Oi(l,d,40),m=new Zt,h=new Ot,g=new H,_=new H,v=(e,n,r,i,a,o,s)=>{for(let t=0;t<n;t++){let c=t/n*Math.PI*2+Math.random()*.5,l=r+Math.random()*(i-r),u=a+Math.random()*(o-a);_.set(Math.cos(c)*l,u*s*.55,Math.sin(c)*l*.85),h.setFromEuler(new cn(0,Math.random()*Math.PI,0)),g.set(u,u*s,u),m.compose(_,h,g),e.setMatrixAt(t,m)}e.instanceMatrix.needsUpdate=!0,e.castShadow=!1,e.receiveShadow=!1,t.add(e)};v(f,34,9,22,.9,2.2,.75),v(p,40,5.5,9,.35,.8,.8);let y=new $o({color:7031343,roughness:.9}),b=new $o({color:2780723,roughness:.85,flatShading:!0});for(let e=0;e<7;e++){let n=e/7*Math.PI*2+.4,r=16+Math.random()*14,i=new En,a=2.2+Math.random()*1.6,o=new G(new da(.12,.2,a,7),y);o.position.y=a/2,i.add(o);let s=new G(new Lo(1.4+Math.random()*.8,1),b);s.position.y=a+.7,s.scale.y=1.15,i.add(s),i.position.set(Math.cos(n)*r,0,Math.sin(n)*r*.8),t.add(i)}let x=document.createElement(`canvas`);x.width=128,x.height=64;let S=x.getContext(`2d`),C=(e,t,n)=>{let r=S.createRadialGradient(e,t,0,e,t,n);r.addColorStop(0,`rgba(255,255,255,0.95)`),r.addColorStop(1,`rgba(255,255,255,0)`),S.fillStyle=r,S.fillRect(0,0,128,64)};C(40,34,26),C(64,28,30),C(90,36,24),C(56,40,22);let w=new ia(x);w.colorSpace=ze;let T=new ai({map:w,transparent:!0,depthWrite:!1,fog:!1});for(let e=0;e<8;e++){let n=new G(new Ro(9,4.5),T),r=e/8*Math.PI*2+.9;n.position.set(Math.cos(r)*32,16+Math.random()*8,Math.sin(r)*32),n.lookAt(0,2,0),t.add(n)}}function qd(e=13710383){let t=new En,n=new $o({color:e,roughness:.55,metalness:.02,emissive:e,emissiveIntensity:0}),r=new G(new da(.093,.093,.014,28),n);r.rotation.x=Math.PI/2,r.castShadow=!0,t.add(r);let i=new $o({color:e,roughness:.5,emissive:e,emissiveIntensity:.12}),a=new G(new da(.093,.093,.004,28),i);a.rotation.x=Math.PI/2,a.position.z=.009,t.add(a);let o=new G(new ca(.028,.105,.02),new $o({color:13213802,roughness:.7}));return o.position.y=-.14,o.castShadow=!0,t.add(o),t.userData.rubberMat=n,t}function Jd(e=16738858,t=2078952){let n=new En,r=new $o({color:14542062,roughness:.35,metalness:.45}),i=new $o({color:4608100,roughness:.5,metalness:.5}),a=new G(new la(.16,.3,6,14),r);a.position.y=1.06,a.castShadow=!0,n.add(a);let o=new G(new Vo(.13,20,16),r);o.position.y=1.47,o.castShadow=!0,n.add(o);let s=new ai({color:e}),c=new G(new ca(.15,.035,.04),s);c.position.set(0,1.49,.11),n.add(c),n.userData.visorMat=s;let l=new G(new da(.006,.006,.12,6),i);l.position.y=1.65,n.add(l);let u=new G(new Vo(.018,10,8),s);u.position.y=1.72,n.add(u);let d=new G(new da(.12,.17,.09,16),i);d.position.y=.82,d.castShadow=!0,n.add(d);let f=new G(new Ho(.15,.014,8,24),new ai({color:t}));f.rotation.x=Math.PI/2,f.position.y=.78,n.add(f);let p=new G(new la(.032,.3,4,10),i);return p.rotation.z=Math.PI/2.4,p.position.set(.24,1.16,.06),n.add(p),n}var Yd=null;function Xd(){if(Yd)return Yd;let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,2,32,32,30);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.55,`rgba(255,255,255,0.5)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),Yd=new ia(e),Yd}var Zd=26,Qd=class{constructor(e,{fake:t=!1}={}){this.fake=t,this.pos=new H(0,1.2,0),this.vel=new H,this.active=!1,this.sunk=!1;let n=t?16767037:16777215;this.mesh=new G(new Vo(yd,20,16),new $o({color:n,roughness:.4,metalness:0,emissive:n,emissiveIntensity:t?.28:.22})),this.mesh.castShadow=!0,e.add(this.mesh),this.trailPts=new Float32Array(78);let r=new kr;r.setAttribute(`position`,new mr(this.trailPts,3)),this.trail=new ta(r,new Xi({map:Xd(),color:t?16758784:6736127,size:t?.03:.038,transparent:!0,opacity:t?.4:.55,sizeAttenuation:!0,depthWrite:!1})),e.add(this.trail),this.trailIdx=0,this.trailTimer=0,this.hide()}hide(){this.active=!1,this.mesh.visible=!1,this.trail.visible=!1}spawn(e,t){this.pos.copy(e),this.vel.copy(t),this.active=!0,this.sunk=!1,this.mesh.visible=!0,this.trail.visible=!0;for(let t=0;t<Zd;t++)this.trailPts[t*3]=e.x,this.trailPts[t*3+1]=e.y,this.trailPts[t*3+2]=e.z;this.trail.geometry.attributes.position.needsUpdate=!0}step(e,t,n){if(!this.active)return;let r=this.pos,i=this.vel;$d.set(0,-vd,0),t&&t(r,i,$d),i.addScaledVector($d,e),i.multiplyScalar(Math.max(0,1-Sd*e));let a=r.x,o=r.z,s=r.y;if(r.addScaledVector(i,e),!this.fake)for(let e of Y.nets){let t=(a-e.ax)*e.nx+(o-e.az)*e.nz,c=(r.x-e.ax)*e.nx+(r.z-e.az)*e.nz;if(t>0==c>0||Math.abs(t-c)<1e-9)continue;let l=t/(t-c),u=a+(r.x-a)*l,d=o+(r.z-o)*l,f=s+(r.y-s)*l,p=e.bx-e.ax,m=e.bz-e.az,h=p*p+m*m,g=((u-e.ax)*p+(d-e.az)*m)/h;if(!(g<-.02||g>1.02)&&f<_d+.034&&f>J-.05){let a=t>0?1:-1;r.x=u+e.nx*a*.02,r.z=d+e.nz*a*.02;let o=i.x*e.nx+i.z*e.nz;i.x-=1.18*o*e.nx,i.z-=1.18*o*e.nz,i.x*=.6,i.z*=.6,i.y=Math.min(i.y,.4)*.4,n?.onNet&&n.onNet();break}}if(!this.sunk&&i.y<0&&r.y-.034<=J&&s-.034>=J-.02&&Y.containsPoint(r.x,r.z)){let e=Y.surfaceAt(r.x,r.z);if(e.hole)this.sunk=!0,!this.fake&&n?.onHole&&n.onHole(Y.sectorOf(r.x,r.z),r.clone());else{if(e.normal){let t=i.dot(e.normal);t<0&&i.addScaledVector(e.normal,-(1+bd)*t),r.y=J+yd+.001}else r.y=J+yd,i.y=-i.y*(e.ice?.7:bd);e.ice?(i.x*=1.02,i.z*=1.02):(i.x*=xd,i.z*=xd),i.y<.3&&(i.y=Math.max(i.y,0)),n?.onBounceTable&&n.onBounceTable(Y.sectorOf(r.x,r.z),r.clone())}}if(i.y<0&&r.y-.034<=0&&(r.y=yd,i.y=-i.y*.55,i.x*=.8,i.z*=.8,n?.onFloor&&n.onFloor(r.clone())),(Math.abs(r.x)>8||Math.abs(r.z)>9||r.y>10)&&n?.onOut&&n.onOut(),this.mesh.position.copy(r),this.trailTimer+=e,this.trailTimer>.012){this.trailTimer=0,this.trailIdx=(this.trailIdx+1)%Zd;let e=this.trailIdx*3;this.trailPts[e]=r.x,this.trailPts[e+1]=r.y,this.trailPts[e+2]=r.z,this.trail.geometry.attributes.position.needsUpdate=!0}}},$d=new H;function ef(e,t,n,r,i,a=3){tf.copy(e),nf.copy(t);let o=1/120;for(let e=0;e<a;e+=o){rf.set(0,-vd,0),i&&i(tf,nf,rf),nf.addScaledVector(rf,o),nf.multiplyScalar(Math.max(0,1-Sd*o));let t=tf.y;if(tf.addScaledVector(nf,o),nf.y<0&&tf.y-.034<=J&&t-.034>=J-.02&&Y.containsPoint(tf.x,tf.z)){let e=Y.surfaceAt(tf.x,tf.z);if(e.hole)return null;if(e.normal){let t=nf.dot(e.normal);t<0&&nf.addScaledVector(e.normal,-(1+bd)*t),tf.y=J+yd+.001}else tf.y=J+yd,nf.y=-nf.y*(e.ice?.7:bd);e.ice?(nf.x*=1.02,nf.z*=1.02):(nf.x*=xd,nf.z*=xd)}if(tf.y<.05)return null;let a=tf.x*n.x+tf.z*n.y,s=nf.x*n.x+nf.z*n.y;if(a>=r&&s>0)return{x:tf.x,y:tf.y,z:tf.z,t:e}}return null}var tf=new H,nf=new H,rf=new H;function af(e,t,n,r=.06){let i=t.x-e.x,a=t.z-e.z,o=Math.max(Math.hypot(i,a),.001)/n,s=0;for(let n=0;n<6;n++){s=(t.y-e.y+.5*vd*o*o)/o;let n=!1;for(let c of Y.nets){let l=(e.x-c.ax)*c.nx+(e.z-c.az)*c.nz,u=(t.x-c.ax)*c.nx+(t.z-c.az)*c.nz;if(l>0==u>0)continue;let d=l/(l-u);if(d<=.02||d>=.98)continue;let f=e.x+i*d,p=e.z+a*d,m=c.bx-c.ax,h=c.bz-c.az,g=m*m+h*h,_=((f-c.ax)*m+(p-c.az)*h)/g;if(_<-.05||_>1.05)continue;let v=d*o;if(e.y+s*v-4.1*v*v<_d+.034+r){n=!0;break}}if(!n)break;o*=1.16}return new H(i/o,s,a/o)}var X=null,of=null,sf=null,cf={};function lf(){if(X){X.state===`suspended`&&X.resume();return}let e=window.AudioContext||window.webkitAudioContext;if(!e)return;X=new e,of=X.createGain(),of.gain.value=.55,of.connect(X.destination);let t=X.sampleRate*.5;sf=X.createBuffer(1,t,X.sampleRate);let n=sf.getChannelData(0);for(let e=0;e<t;e++)n[e]=Math.random()*2-1}function uf(e,t,n,r){let i=e.gain;i.setValueAtTime(1e-4,t),i.exponentialRampToValueAtTime(Math.max(n,2e-4),t+.004),i.exponentialRampToValueAtTime(1e-4,t+r)}function df(e,t,n,r,i=`square`){if(!X)return;let a=X.currentTime,o=X.createOscillator(),s=X.createGain();o.type=i,o.frequency.setValueAtTime(e,a),o.frequency.exponentialRampToValueAtTime(Math.max(t,1),a+n),uf(s,a,r,n),o.connect(s).connect(of),o.start(a),o.stop(a+n+.02)}function ff(e,t,n,r=1){if(!X)return;let i=X.currentTime,a=X.createBufferSource();a.buffer=sf;let o=X.createBiquadFilter();o.type=`bandpass`,o.frequency.value=n,o.Q.value=r;let s=X.createGain();uf(s,i,t,e),a.connect(o).connect(s).connect(of),a.start(i),a.stop(i+e+.02)}var pf={paddleHit(e=.5){df(300+e*260,110,.09,.45+e*.3,`square`),ff(.05,.3+e*.35,2400+e*1800,.8)},botHit(e=.5){df(240+e*180,95,.09,.35,`square`),ff(.05,.25,1900,.8)},bounce(){df(190,90,.06,.28,`sine`),ff(.03,.12,1200,1)},net(){ff(.12,.3,420,.6),df(130,60,.1,.15,`sine`)},block(){df(520,240,.07,.3,`triangle`),ff(.04,.2,3200,1)},swish(){ff(.16,.1,900,.4)},charge(){},pointWin(){df(523,523,.09,.3,`triangle`),setTimeout(()=>df(784,784,.14,.3,`triangle`),90)},pointLose(){df(392,392,.09,.25,`triangle`),setTimeout(()=>df(262,262,.16,.25,`triangle`),90)},gameWin(){[523,659,784,1047].forEach((e,t)=>setTimeout(()=>df(e,e,.22,.3,`triangle`),t*130))},gameLose(){[392,330,262,196].forEach((e,t)=>setTimeout(()=>df(e,e,.24,.25,`triangle`),t*150))},swallowed(){df(600,40,.7,.35,`sawtooth`)}};function mf(e,t){if(!X||cf[e])return;let n=X.createGain();n.gain.value=0,n.connect(of);let r;if(t===`hum`){r=X.createOscillator(),r.type=`sine`,r.frequency.value=46;let t=X.createOscillator();t.frequency.value=.6;let i=X.createGain();i.gain.value=8,t.connect(i).connect(r.frequency),t.start(),r.connect(n),r.start(),n.gain.linearRampToValueAtTime(.07,X.currentTime+1.2),cf[e]={nodes:[r,t],g:n}}else if(t===`wind`){r=X.createBufferSource(),r.buffer=sf,r.loop=!0;let t=X.createBiquadFilter();t.type=`lowpass`,t.frequency.value=520,r.connect(t).connect(n),r.start(),n.gain.linearRampToValueAtTime(.05,X.currentTime+1.2),cf[e]={nodes:[r],g:n}}}function hf(e){let t=cf[e];if(!t||!X)return;t.g.gain.linearRampToValueAtTime(1e-4,X.currentTime+.4);let n=t.nodes;setTimeout(()=>n.forEach(e=>{try{e.stop()}catch{}}),600),delete cf[e]}function gf(){Object.keys(cf).forEach(hf)}var _f=null,vf=60/112/4,yf=[57,57,53,53,48,48,55,55],bf=[0,3,7,12,7,3,0,3],xf=e=>440*2**((e-69)/12);function Sf(){if(!X||_f)return;let e=X.createGain();e.gain.value=0,e.connect(of),e.gain.linearRampToValueAtTime(.32,X.currentTime+1.5);let t=X.createDelay(1);t.delayTime.value=vf*3;let n=X.createGain();n.gain.value=.3;let r=X.createGain();r.gain.value=.35,t.connect(n).connect(t),t.connect(r).connect(e),_f={bus:e,delay:t,wet:r,step:0,nextT:X.currentTime+.1,timer:null,muted:!1};let i=(n,r)=>{let i=Math.floor(n/16)%8,a=n%16,o=yf[i];if(a%4==0){let t=X.createOscillator(),n=X.createGain();t.type=`sine`,t.frequency.setValueAtTime(140,r),t.frequency.exponentialRampToValueAtTime(42,r+.1),n.gain.setValueAtTime(.9,r),n.gain.exponentialRampToValueAtTime(.001,r+.16),t.connect(n).connect(e),t.start(r),t.stop(r+.2)}if(a===4||a===12){let t=X.createBufferSource();t.buffer=sf;let n=X.createBiquadFilter();n.type=`bandpass`,n.frequency.value=1900,n.Q.value=.8;let i=X.createGain();i.gain.setValueAtTime(.4,r),i.gain.exponentialRampToValueAtTime(.001,r+.14),t.connect(n).connect(i).connect(e),t.start(r),t.stop(r+.16)}if(a%2==0){let t=X.createBufferSource();t.buffer=sf;let n=X.createBiquadFilter();n.type=`highpass`,n.frequency.value=8e3;let i=X.createGain(),o=a%4==2?.18:.07;i.gain.setValueAtTime(o,r),i.gain.exponentialRampToValueAtTime(.001,r+.04),t.connect(n).connect(i).connect(e),t.start(r),t.stop(r+.05)}if(a%2==0){let t=o-24+(a%8==6?12:0),n=X.createOscillator(),i=X.createGain(),s=X.createBiquadFilter();s.type=`lowpass`,s.frequency.value=480,s.Q.value=6,n.type=`sawtooth`,n.frequency.value=xf(t),i.gain.setValueAtTime(.24,r),i.gain.exponentialRampToValueAtTime(.001,r+vf*1.9),n.connect(s).connect(i).connect(e),n.start(r),n.stop(r+vf*2)}{let n=o+bf[a%8]+(a>=8?12:0),i=X.createOscillator(),s=X.createGain();i.type=`square`,i.frequency.value=xf(n),s.gain.setValueAtTime(.055,r),s.gain.exponentialRampToValueAtTime(.001,r+vf*.9),i.connect(s),s.connect(e),s.connect(t),i.start(r),i.stop(r+vf)}if(a===0)for(let t of[0,7]){let n=X.createOscillator(),i=X.createGain();n.type=`triangle`,n.frequency.value=xf(o-12+t),i.gain.setValueAtTime(1e-4,r),i.gain.linearRampToValueAtTime(.05,r+.4),i.gain.linearRampToValueAtTime(1e-4,r+vf*16),n.connect(i).connect(e),n.start(r),n.stop(r+vf*16+.1)}};_f.timer=setInterval(()=>{if(!(!X||!_f))for(;_f.nextT<X.currentTime+.25;)i(_f.step,_f.nextT),_f.step++,_f.nextT+=vf},90)}function Cf(){if(!_f)return;clearInterval(_f.timer);let e=_f.bus;X&&(e.gain.linearRampToValueAtTime(1e-4,X.currentTime+.8),setTimeout(()=>e.disconnect(),1e3)),_f=null}function wf(){return _f?(Cf(),!1):(X||lf(),Sf(),!0)}Object.assign(pf,{boom(e=1){df(90,30,.4,.5*e,`sine`),ff(.35,.45*e,350,.4)},meteorWhistle(){df(2200,600,.8,.06,`sine`)},rumble(){df(60,28,1.4,.35,`sine`),ff(1.2,.2,160,.3)},chomp(){ff(.09,.5,900,.7),setTimeout(()=>{df(160,60,.18,.45,`square`),ff(.15,.4,500,.5)},110)},eruption(){ff(.9,.3,300,.35),df(70,40,.7,.2,`sine`)},sunk(){df(700,60,.5,.35,`sine`),setTimeout(()=>ff(.12,.25,800,.6),380)}});var Tf={fan:`🌬️ CROSSWIND FAN`,block:`🧱 FLOATING BLOCK`,blackhole:`🕳️ BLACK HOLE`,fakeballs:`🟡 DECOY BALLS`,bumpy:`🪨 BUMPY TABLE`,giant:`🐘 GIANT TABLE`,tiny:`🐜 TINY TABLE`,volcano:`🌋 VOLCANOES`,meteor:`☄️ METEOR SHOWER`,snow:`❄️ SNOW & ICE`,drunk:`🍺 DRUNK MODE`,giantpaddle:`🏓 GIANT PADDLE`,quake:`🌍 EARTHQUAKES`,bite:`👹 MONSTER BITE`,strobe:`⚡ STROBE ⚠️`},Ef=Object.keys(Tf),Df=class{constructor(e){this.scene=e,this.group=new En,e.add(this.group),this.active=[],this.roster=[],this.flags={drunk:!1,giantPaddle:!1,strobe:!1,snowSlip:!1},this.quake=0,this.pendingShake=0,this.fakeBalls=[];for(let t=0;t<3;t++)this.fakeBalls.push(new Qd(e,{fake:!0}));this.bursts=[],this.time=0,typeof window<`u`&&(window.__obstacles=this)}labels(){return this.roster.map(e=>Tf[e])}roll(e,{allowStrobe:t=!0}={}){this.clear();let n=0;e>=2&&e<=4?n=1:e>=5&&e<=8?n=1+ +(Math.random()<.6):e>=9&&(n=2+ +(Math.random()<.35));let r=Ef.filter(e=>t||e!==`strobe`),i=[];for(let e=0;e<n&&r.length;e++){let e=Math.floor(Math.random()*r.length),t=r.splice(e,1)[0];i.push(t);let n=e=>{let t=r.indexOf(e);t>=0&&r.splice(t,1)};t===`giant`&&n(`tiny`),t===`tiny`&&n(`giant`)}return this.roster=i,i}apply(e){this.roster=e;for(let t of e)this.spawn(t,Math.random)}spawn(e,t=Math.random){let n={fan:()=>this.spawnFan(t),block:()=>this.spawnBlock(t),blackhole:()=>this.spawnBlackHole(t),fakeballs:()=>this.spawnFakeBalls(t),bumpy:()=>this.spawnBumpy(t),volcano:()=>this.spawnVolcano(t),meteor:()=>this.spawnMeteor(t),snow:()=>this.spawnSnow(t),bite:()=>this.spawnBite(t),quake:()=>{this.active.push({type:`quake`,next:2+t()*3,phase:0,meshes:[]})},drunk:()=>{this.flags.drunk=!0},giantpaddle:()=>{this.flags.giantPaddle=!0},strobe:()=>{this.flags.strobe=!0},giant:()=>{},tiny:()=>{}}[e];n&&n(),this.roster.includes(e)||this.roster.push(e)}spawnFan(e){let t=e()<.5?-1:1,n=(e()*1.4-.7)*Y.scale,r=Math.max(2,Y.halfL+.7),i=new En,a=new $o({color:3752014,roughness:.4,metalness:.7}),o=new G(new da(.03,.045,1.15,10),a);o.position.y=.575,o.castShadow=!0,i.add(o);let s=new G(new da(.22,.26,.05,16),a);s.position.y=.025,s.castShadow=!0,i.add(s);let c=new G(new Ho(.3,.025,10,28),a);c.position.y=1.25,c.rotation.y=Math.PI/2,i.add(c);let l=new En,u=new $o({color:10475775,roughness:.3,metalness:.4,transparent:!0,opacity:.9,side:2});for(let e=0;e<4;e++){let t=new G(new Ro(.1,.24),u);t.position.y=.14;let n=new En;n.rotation.x=e/4*Math.PI*2,t.rotation.y=.6,n.add(t),l.add(n)}l.position.y=1.25,i.add(l);let d=new G(new Vo(.05,12,10),a);d.position.y=1.25,i.add(d),i.position.set(t*r,0,n),i.rotation.y=t>0?0:Math.PI,this.group.add(i);let f=new Float32Array(120),p=[],m=r*2;for(let e=0;e<40;e++)p.push({p:Math.random()*m,y:1+Math.random()*.8,z:n+(Math.random()-.5)*1.1});let h=new kr;h.setAttribute(`position`,new mr(f,3));let g=new ta(h,new Xi({map:Xd(),color:15267583,size:.05,transparent:!0,opacity:.5,depthWrite:!1}));this.group.add(g),mf(`fan`,`wind`),this.active.push({type:`fan`,dir:-t,zPos:n,standOff:r,span:m,strength:3.2+Math.random()*1.2,blades:l,streaks:g,seeds:p,meshes:[i,g]})}spawnBlock(e){let t=Math.max(.7,Y.scale),n=(e()*1-.5)*t,r=(e()<.5?-1:1)*(.35+e()*.45)*t,i=new H(.52,.34,.14),a=new G(new ca(i.x,i.y,i.z),new $o({color:11828735,roughness:.25,metalness:.3,emissive:5910182,emissiveIntensity:.5}));a.castShadow=!0;let o=new Yi(new va(a.geometry),new Li({color:15125759,transparent:!0,opacity:.8}));a.add(o),this.group.add(a),this.active.push({type:`block`,mesh:a,size:i,x0:n,z0:r,y0:J+.55+e()*.3,phase:e()*Math.PI*2,ampX:.35+e()*.3,spdX:.5+e()*.4,ampY:.08,spdY:1.3,pos:new H,meshes:[a]})}spawnBlackHole(e){let t=Y.randomPointOnTable(.8),n=J+.42+e()*.28,r=new En,i=new G(new Vo(.09,24,18),new ai({color:0}));r.add(i);let a=new G(new Ho(.15,.028,10,40),new ai({color:9055202,transparent:!0,opacity:.9}));a.rotation.x=Math.PI/2.4,r.add(a);let o=new G(new Ho(.21,.012,8,40),new ai({color:3805066,transparent:!0,opacity:.6}));o.rotation.x=Math.PI/2.1,r.add(o);let s=new Float32Array(180),c=[];for(let e=0;e<60;e++)c.push({a:Math.random()*Math.PI*2,r:.14+Math.random()*.3,s:1.5+Math.random()*2.5,tilt:(Math.random()-.5)*.5});let l=new kr;l.setAttribute(`position`,new mr(s,3));let u=new ta(l,new Xi({map:Xd(),color:8007392,size:.026,transparent:!0,opacity:.9,depthWrite:!1}));r.add(u);let d=document.createElement(`canvas`);d.width=d.height=128;let f=d.getContext(`2d`),p=f.createRadialGradient(64,64,6,64,64,64);p.addColorStop(0,`rgba(90,20,160,0.55)`),p.addColorStop(.4,`rgba(120,40,200,0.30)`),p.addColorStop(1,`rgba(80,20,160,0)`),f.fillStyle=p,f.fillRect(0,0,128,128);let m=new Yr(new Fr({map:new ia(d),transparent:!0,depthWrite:!1}));m.scale.set(.7,.7,1),r.add(m);let h=new js(10178047,1.4,3.2);r.add(h),r.position.set(t.x,n,t.z),this.group.add(r),mf(`blackhole`,`hum`),this.active.push({type:`blackhole`,g:r,disk:a,disk2:o,swirl:u,seeds:c,pos:new H(t.x,n,t.z),G:2.9,captureR:.1,meshes:[r]})}spawnFakeBalls(e){let t=2+ +(e()<.5),n={type:`fakeballs`,n:t,timers:[],meshes:[]};for(let e=0;e<t;e++)n.timers.push(.5+e*.9),this.launchFake(e);this.active.push(n)}launchFake(e){let t=this.fakeBalls[e],n=Math.random()<.5,r=n?-2.4:2.4,i=Math.random()*3-1.5,a=1+Math.random()*.8,o=new H((n?1:-1)*(1.6+Math.random()*1.6),1.6+Math.random()*1.6,(Math.random()-.5)*2.4);t.spawn(new H(r,a,i),o)}spawnBumpy(e){let t={type:`bumpy`,meshes:[]},n=new $o({color:3106500,roughness:.4}),r=8+Math.floor(e()*4);for(let i=0;i<r;i++){let r=Y.randomPointOnTable(.85);if(Y.distToNets(r.x,r.z)<.14)continue;let i=.1+e()*.07,a=.035+e()*.025;Y.surface.bumps.push({x:r.x,z:r.z,r:i,h:a});let o=new G(new Vo(1,14,10),n);o.scale.set(i,a,i),o.position.set(r.x,J,r.z),o.castShadow=!0,this.group.add(o),t.meshes.push(o)}this.active.push(t)}spawnVolcano(e){let t=1+ +(e()<.4);for(let n=0;n<t;n++){let t=Y.randomPointOnTable(.7);for(let e=0;e<10&&Y.distToNets(t.x,t.z)<.3;e++)t=Y.randomPointOnTable(.7);let n=.16,r=.24,i=new En,a=new G(new fa(n,r,12,1,!0),new $o({color:7027236,roughness:.9,flatShading:!0,side:2}));a.position.y=r/2,a.castShadow=!0,i.add(a);let o=new G(new ua(n*.35,10),new ai({color:16734746}));o.rotation.x=-Math.PI/2,o.position.y=.235,i.add(o),i.position.set(t.x,J,t.z),this.group.add(i);let s=new Float32Array(108).fill(9999),c=Array.from({length:36},()=>({life:-1,p:new H,v:new H})),l=new kr;l.setAttribute(`position`,new mr(s,3));let u=new ta(l,new Xi({map:Xd(),color:16742944,size:.045,transparent:!0,opacity:.95,depthWrite:!1}));this.group.add(u),this.active.push({type:`volcano`,x:t.x,z:t.z,baseR:n,h:r,nextEruption:1.5+e()*3,erupting:0,crater:o.material,lava:u,seeds:c,meshes:[i,u]})}}spawnMeteor(e){let t=new $o({color:5519135,roughness:.8,flatShading:!0,emissive:16734746,emissiveIntensity:.8});this.active.push({type:`meteor`,timer:1+e(),holesMade:0,meteors:[],mat:t,meshes:[]})}launchMeteor(e){let t=Y.randomPointOnTable(.85);Math.random()<.25&&(t.x+=(Math.random()<.5?-1:1)*2.5,t.z+=(Math.random()*2-1)*2);let n=Math.random()*Math.PI*2,r=new H(t.x+Math.cos(n)*3.2,5.5,t.z+Math.sin(n)*3.2),i=.9,a=new H((t.x-r.x)/i,-(5.5-J)/i,(t.z-r.z)/i),o=new G(new Lo(.07,0),e.mat),s=new Yr(new Fr({map:Xd(),color:16744496,transparent:!0,opacity:.8,depthWrite:!1}));s.scale.set(.3,.3,1),o.add(s),this.group.add(o),e.meteors.push({pos:r.clone(),vel:a,mesh:o}),e.meshes.push(o),pf.meteorWhistle?.()}spawnSnow(e){this.flags.snowSlip=!0,Y.surface.ice=!0,Id.setSnow();let t=new Float32Array(960),n=[];for(let e=0;e<320;e++)n.push({x:(Math.random()*2-1)*5,y:Math.random()*4.5,z:(Math.random()*2-1)*5,s:.35+Math.random()*.5,ph:Math.random()*Math.PI*2});let r=new kr;r.setAttribute(`position`,new mr(t,3));let i=new ta(r,new Xi({map:Xd(),color:16777215,size:.035,transparent:!0,opacity:.85,depthWrite:!1}));this.group.add(i),this.active.push({type:`snow`,flakes:i,seeds:n,meshes:[i]})}spawnBite(e){let t,n;if(Y.mode===`classic`){let r=Math.floor(e()*4);if(r<2){let i=r===0?-1:1;t=new V(i*Y.halfW,(e()*2-1)*Y.halfL*.6),n=new V(i,0)}else{let i=r===2?-1:1;t=new V((e()*2-1)*Y.halfW*.7,i*Y.halfL),n=new V(0,i)}}else{let r=Math.floor(e()*3),i=Y.seatDirs[r],a=Y.seatTans[r],o=(e()*2-1)*Y.edgeHalf*.5;t=new V(i.x*Y.apothem+a.x*o,i.y*Y.apothem+a.y*o),n=i.clone()}let r=new En,i=new $o({color:5909882,roughness:.6,flatShading:!0}),a=new G(new Lo(.34,1),i);a.scale.y=1.15,a.castShadow=!0,r.add(a);let o=new ai({color:16769357});for(let e of[-.14,.14]){let t=new G(new Vo(.055,10,8),o);t.position.set(e,.16,-.26),r.add(t);let n=new G(new Vo(.024,8,6),new ai({color:1118481}));n.position.set(e,.16,-.3),r.add(n)}let s=new $o({color:16119274,roughness:.4});for(let e=0;e<6;e++){let t=new G(new fa(.035,.11,5),s);t.position.set(-.2+e*.08,-.2,-.26),t.rotation.x=Math.PI,r.add(t)}let c=new G(new Vo(.24,12,8,0,Math.PI*2,Math.PI/2),i);c.position.y=-.22,r.add(c);let l=t.x+n.x*.42,u=t.y+n.y*.42;r.position.set(l,-.6,u),r.lookAt(t.x,J,t.y),this.group.add(r),this.active.push({type:`bite`,g:r,jaw:c,t:0,done:!1,holeX:t.x-n.x*.13,holeZ:t.y-n.y*.13,holeR:.3,meshes:[r]})}forceFn=(e,t,n)=>{for(let t of this.active)if(t.type===`fan`)e.y>J-.05&&e.y<J+1.2&&Math.abs(e.z-t.zPos)<.62&&Math.abs(e.x)<t.standOff&&(n.x+=t.dir*t.strength);else if(t.type===`blackhole`){Of.subVectors(t.pos,e);let r=Math.max(Of.lengthSq(),.05),i=Math.min(t.G/r,16);n.addScaledVector(Of.normalize(),i)}else if(t.type===`volcano`&&t.erupting>0){let r=e.x-t.x,i=e.z-t.z;r*r+i*i<.09&&e.y>J&&e.y<J+1.4&&(n.y+=10,n.x+=(Math.random()-.5)*4,n.z+=(Math.random()-.5)*4)}else t.type===`quake`&&this.quake>0&&(n.x+=(Math.random()-.5)*7*this.quake,n.z+=(Math.random()-.5)*7*this.quake)};collideBall(e){let t=!1;for(let n of this.active)if(n.type===`block`){let r=e.pos,i=n.size,a=n.pos,o=Math.max(a.x-i.x/2,Math.min(r.x,a.x+i.x/2)),s=Math.max(a.y-i.y/2,Math.min(r.y,a.y+i.y/2)),c=Math.max(a.z-i.z/2,Math.min(r.z,a.z+i.z/2));Of.set(r.x-o,r.y-s,r.z-c);let l=Of.length();if(l<.034&&l>1e-6){Of.normalize(),r.addScaledVector(Of,yd-l+.002);let i=e.vel.dot(Of);i<0&&(e.vel.addScaledVector(Of,-1.75*i),e.fake||(pf.block(),n.mesh.material.emissiveIntensity=1.6)),t=!0}}else if(n.type===`volcano`){let r=e.pos.y-J;if(r>-.02&&r<n.h){let i=n.baseR*(1-r/n.h)+yd,a=e.pos.x-n.x,o=e.pos.z-n.z,s=Math.hypot(a,o);if(s<i&&s>1e-6){Of.set(a/s,.4,o/s).normalize(),e.pos.x=n.x+a/s*i,e.pos.z=n.z+o/s*i;let r=e.vel.dot(Of);r<0&&(e.vel.addScaledVector(Of,-1.7*r),e.fake||pf.block()),t=!0}}}return t}checkCapture(e){for(let t of this.active)if(t.type===`blackhole`&&e.pos.distanceTo(t.pos)<t.captureR)return!0;return!1}consumeShake(){let e=this.pendingShake;return this.pendingShake=0,e}burst(e,t,n=22,r=2.6){let i=new Float32Array(n*3),a=[];for(let t=0;t<n;t++){let t=Math.random()*Math.PI*2,n=Math.random()*Math.PI/2,i=r*(.4+Math.random()*.8);a.push({p:e.clone(),v:new H(Math.cos(t)*Math.cos(n)*i,Math.sin(n)*i*1.4,Math.sin(t)*Math.cos(n)*i)})}let o=new kr;o.setAttribute(`position`,new mr(i,3));let s=new ta(o,new Xi({map:Xd(),color:t,size:.055,transparent:!0,opacity:1,depthWrite:!1}));this.group.add(s),this.bursts.push({mesh:s,seeds:a,life:.7})}update(e){this.time+=e;let t=this.time;this.quake=0;for(let n of this.active)if(n.type===`fan`){n.blades.rotation.x+=e*22;let t=n.streaks.geometry.attributes.position;for(let r=0;r<n.seeds.length;r++){let i=n.seeds[r];i.p+=e*(2.2+n.strength*.4),i.p>n.span&&(i.p=0,i.y=1+Math.random()*.8,i.z=n.zPos+(Math.random()-.5)*1.1),t.setXYZ(r,-n.dir*n.standOff+n.dir*i.p,i.y,i.z)}t.needsUpdate=!0}else if(n.type===`block`)n.pos.set(n.x0+Math.sin(t*n.spdX+n.phase)*n.ampX,n.y0+Math.sin(t*n.spdY+n.phase)*n.ampY,n.z0),n.mesh.position.copy(n.pos),n.mesh.rotation.y=Math.sin(t*.4+n.phase)*.3,n.mesh.material.emissiveIntensity+=(.5-n.mesh.material.emissiveIntensity)*Math.min(1,e*5);else if(n.type===`blackhole`){n.disk.rotation.z+=e*2.4,n.disk2.rotation.z-=e*1.6;let t=n.swirl.geometry.attributes.position;for(let r=0;r<n.seeds.length;r++){let i=n.seeds[r];i.a+=e*i.s,i.r-=e*.06,i.r<.1&&(i.r=.32+Math.random()*.15),t.setXYZ(r,Math.cos(i.a)*i.r,Math.sin(i.a*.7)*i.r*i.tilt,Math.sin(i.a)*i.r)}t.needsUpdate=!0}else if(n.type===`fakeballs`)for(let t=0;t<n.n;t++){let r=this.fakeBalls[t];r.step(e,this.forceFn,null),this.collideBall(r),n.timers[t]-=e,(n.timers[t]<=0&&Math.abs(r.pos.x)>2.6||r.pos.y<.12||Math.abs(r.pos.z)>4.5||Math.abs(r.pos.x)>4.5)&&(this.launchFake(t),n.timers[t]=2+Math.random()*2)}else if(n.type===`volcano`){if(n.erupting>0){n.erupting-=e,n.crater.color.setHex(16752704);for(let e of n.seeds)e.life<=0&&Math.random()<.4&&(e.life=.5+Math.random()*.4,e.p.set(n.x+(Math.random()-.5)*.04,J+n.h,n.z+(Math.random()-.5)*.04),e.v.set((Math.random()-.5)*1.4,2.2+Math.random()*1.6,(Math.random()-.5)*1.4))}else n.nextEruption-=e,n.crater.color.setHex(16734746),n.nextEruption<=0&&(n.erupting=1.2,n.nextEruption=2.5+Math.random()*3.5,pf.eruption?.());let t=n.lava.geometry.attributes.position;for(let r=0;r<n.seeds.length;r++){let i=n.seeds[r];i.life>0?(i.life-=e,i.v.y-=6*e,i.p.addScaledVector(i.v,e),t.setXYZ(r,i.p.x,i.p.y,i.p.z)):t.setXYZ(r,9999,9999,9999)}t.needsUpdate=!0}else if(n.type===`meteor`){n.timer-=e,n.timer<=0&&n.holesMade<5&&n.meteors.length<2&&(this.launchMeteor(n),n.timer=1.6+Math.random()*1.6);for(let t=n.meteors.length-1;t>=0;t--){let r=n.meteors[t];r.pos.addScaledVector(r.vel,e),r.mesh.position.copy(r.pos),r.mesh.rotation.x+=e*9,r.mesh.rotation.y+=e*7;let i=Y.containsPoint(r.pos.x,r.pos.z)?J:.02;if(r.pos.y<=i){if(this.group.remove(r.mesh),n.meteors.splice(t,1),i===J&&!Y.surfaceAt(r.pos.x,r.pos.z).hole){let e=.14+Math.random()*.07;Y.surface.holes.push({x:r.pos.x,z:r.pos.z,r:e}),Id.addHoleDecal(r.pos.x,r.pos.z,e,`meteor`),n.holesMade++,this.burst(new H(r.pos.x,J+.05,r.pos.z),16744496,26,3),this.pendingShake=Math.max(this.pendingShake,.5),pf.boom?.()}else this.burst(new H(r.pos.x,i+.05,r.pos.z),9071162,16,2),this.pendingShake=Math.max(this.pendingShake,.2),pf.boom?.(.4)}}}else if(n.type===`snow`){let r=n.flakes.geometry.attributes.position;for(let i=0;i<n.seeds.length;i++){let a=n.seeds[i];a.y-=e*a.s,a.y<.02&&(a.y=4.2+Math.random()*.4),r.setXYZ(i,a.x+Math.sin(t*.8+a.ph)*.25,a.y,a.z+Math.cos(t*.6+a.ph)*.2)}r.needsUpdate=!0}else if(n.type===`quake`)n.phase>0?(n.phase-=e,this.quake=Math.max(this.quake,Math.sin(Math.min(1,n.phase/1.6)*Math.PI)*.9)):(n.next-=e,n.next<=0&&(n.phase=1.6,n.next=3.5+Math.random()*3.5,pf.rumble?.()));else if(n.type===`bite`){n.t+=e;let t=n.g;if(n.t<.7)t.position.y=-.6+n.t/.7*(J+.75);else if(n.t<1){let e=(n.t-.7)/.3;n.jaw.position.y=-.22+Math.sin(e*Math.PI)*.12,!n.done&&e>.5&&(n.done=!0,Y.surface.holes.push({x:n.holeX,z:n.holeZ,r:n.holeR}),Id.addHoleDecal(n.holeX,n.holeZ,n.holeR,`bite`),this.pendingShake=Math.max(this.pendingShake,.35),pf.chomp?.())}else n.t<2.2?t.position.y=J+.15-(n.t-1)/1.2*(J+.9):t.visible=!1}for(let t=this.bursts.length-1;t>=0;t--){let n=this.bursts[t];if(n.life-=e,n.life<=0){this.group.remove(n.mesh),n.mesh.geometry.dispose(),n.mesh.material.dispose(),this.bursts.splice(t,1);continue}let r=n.mesh.geometry.attributes.position;for(let t=0;t<n.seeds.length;t++){let i=n.seeds[t];i.v.y-=7*e,i.p.addScaledVector(i.v,e),r.setXYZ(t,i.p.x,i.p.y,i.p.z)}r.needsUpdate=!0,n.mesh.material.opacity=Math.min(1,n.life/.35)}}clear(){for(let e of this.active)for(let t of e.meshes||[])this.group.remove(t);for(let e of this.bursts)this.group.remove(e.mesh);this.bursts=[],this.active=[],this.roster=[],this.flags={drunk:!1,giantPaddle:!1,strobe:!1,snowSlip:!1},this.quake=0,this.pendingShake=0;for(let e of this.fakeBalls)e.hide();gf()}},Of=new H,kf=e=>document.getElementById(e),Af={scoreboard:kf(`scoreboard`),banner:kf(`obstacle-banner`),message:kf(`message`),hint:kf(`hint`),chargeWrap:kf(`charge-wrap`),chargeFill:kf(`charge-fill`),menu:kf(`menu`),gameover:kf(`gameover`),goTitle:kf(`gameover-title`),goScore:kf(`gameover-score`)},jf=null,Mf=null,Nf=[],Pf=[],Ff={els:Af,showScoreboard(e){Af.scoreboard.classList.toggle(`show`,e)},buildScoreboard(e,t){Af.scoreboard.innerHTML=``,Nf=[],Pf=[],e.forEach((e,n)=>{if(n>0){let e=document.createElement(`span`);e.className=`divider`,e.textContent=`·`,Af.scoreboard.appendChild(e)}let r=document.createElement(`div`);r.className=`side`,r.innerHTML=`<span class="name">${e}</span><span class="pts" style="color:${t[n]};text-shadow:0 0 18px ${t[n]}59">0</span><span class="serve-dot" style="background:${t[n]};box-shadow:0 0 8px ${t[n]}"></span>`,Af.scoreboard.appendChild(r),Nf.push(r.querySelector(`.pts`)),Pf.push(r)})},setScore(e){e.forEach((e,t)=>{Nf[t]&&(Nf[t].textContent=e)})},setServer(e){Pf.forEach((t,n)=>t.classList.toggle(`serving`,n===e))},banner(e){e.length===0?(Af.banner.textContent=`✓ CLEAN TABLE`,Af.banner.classList.add(`clean`)):(Af.banner.textContent=e.join(`   `),Af.banner.classList.remove(`clean`)),Af.banner.classList.add(`show`)},hideBanner(){Af.banner.classList.remove(`show`)},message(e,t=``,n=1400){clearTimeout(jf),Af.message.innerHTML=e+(t?`<span class="sub">${t}</span>`:``),Af.message.classList.add(`show`),n>0&&(jf=setTimeout(()=>Af.message.classList.remove(`show`),n))},clearMessage(){clearTimeout(jf),Af.message.classList.remove(`show`)},hint(e,t=0){clearTimeout(Mf),Af.hint.textContent=e,Af.hint.classList.add(`show`),t>0&&(Mf=setTimeout(()=>Af.hint.classList.remove(`show`),t))},clearHint(){clearTimeout(Mf),Af.hint.classList.remove(`show`)},charge(e){Af.chargeWrap.classList.toggle(`show`,e!==null),e!==null&&(Af.chargeFill.style.width=(e*100).toFixed(1)+`%`)},showMenu(e){Af.menu.classList.toggle(`hidden`,!e)},showGameOver(e,t,n){Af.goTitle.textContent=t,Af.goTitle.classList.toggle(`win`,e),Af.goTitle.classList.toggle(`lose`,!e),Af.goScore.textContent=n,Af.gameover.classList.remove(`hidden`)},hideGameOver(){Af.gameover.classList.add(`hidden`)}},If=Ud(document.getElementById(`app`)),Lf=Wd(),Rf=Gd();Id.init(Rf);var Z=new Qd(Rf),zf=new Df(Rf),Bf=qd(13710383);Rf.add(Bf);var Vf={classic:{names:[`YOU`,`BOT`],colors:[`#4de1ff`,`#ff9d4d`],labels:[`YOU`,`THE BOT`],paddle:[null,16746547],accent:[null,16738858],ring:[null,2078952]},hex:{names:[`YOU`,`RED`,`BLU`],colors:[`#4de1ff`,`#ff5470`,`#5b8dff`],labels:[`YOU`,`RED BOT`,`BLUE BOT`],paddle:[null,14692432,3894496],accent:[null,16733296,6000127],ring:[null,16757696,10470399]}},Hf=62;function Uf(){let e=window.innerWidth/window.innerHeight;Lf.aspect=e,Hf=e>=1?62:Math.min(Dt.radToDeg(2*Math.atan(Math.tan(Dt.degToRad(62)/2)/e)),105),Lf.fov=Hf,Lf.updateProjectionMatrix(),If.setSize(window.innerWidth,window.innerHeight)}window.addEventListener(`resize`,Uf),Uf();var Q={state:`menu`,mode:`classic`,diff:Dd.medium,scores:[0,0],server:0,lastHitter:-1,legalBounce:!1,rallyClock:0,slowClock:0,pointPending:null,serveTimer:0},$={x:0,y:1.1,tx:0,ty:1.1,vx:0,charging:!1,chargeStart:0,charge:0,swing:0,swingPower:0,cooldown:0,scale:1},Wf=[],Gf={shake:0,kick:0};function Kf(){return Vf[Q.mode]}function qf(e){return Kf().labels[e]}function Jf(){for(let e of Wf)Rf.remove(e.paddle),Rf.remove(e.avatar);Wf=[];let e=Kf();for(let t=1;t<Y.seats;t++){let n=qd(e.paddle[t]);Rf.add(n);let r=Jd(e.accent[t],e.ring[t]);Rf.add(r),Wf.push({seat:t,paddle:n,avatar:r,along:0,y:1.08,targetAlong:0,targetY:1.08,avatarAlong:0,reactClock:0,errA:0,errY:0,cooldown:0,swingAnim:0,attempted:!1})}Yf()}function Yf(){for(let e of Wf){e.dir=Y.seatDirs[e.seat],e.tan=Y.seatTans[e.seat],e.faceY=Math.atan2(-e.dir.x,-e.dir.y),e.along=0,e.y=1.08;let t=Y.robotDist+.45;e.avatar.position.set(e.dir.x*t,0,e.dir.y*t),e.avatar.rotation.y=e.faceY}}function Xf(e){let t=e.clientX/window.innerWidth*2-1,n=-(e.clientY/window.innerHeight*2-1);$.tx=Dt.clamp(t*Y.playerXRange*1.15,-Y.playerXRange,Y.playerXRange),$.ty=Dt.clamp(Cd+(n+1)/2*(wd-Cd)*1.15,Cd,wd)}window.addEventListener(`pointermove`,Xf,{passive:!0}),window.addEventListener(`pointerdown`,e=>{lf(),!e.target.closest(`.overlay`)&&(Xf(e),(Q.state===`serve`||Q.state===`rally`)&&($.charging=!0,$.chargeStart=performance.now()))},{passive:!0}),window.addEventListener(`pointerup`,()=>{if(!$.charging)return;$.charging=!1;let e=(performance.now()-$.chargeStart)/1e3,t=Dt.clamp(e/1,.08,1);Ff.charge(null),Q.state===`serve`&&Q.server===0?rp(t):Q.state===`rally`&&($.swing=Td,$.swingPower=t,pf.swish())}),window.addEventListener(`pointercancel`,()=>{$.charging=!1,Ff.charge(null)}),window.addEventListener(`contextmenu`,e=>e.preventDefault()),window.addEventListener(`keydown`,e=>{if(e.key===`m`||e.key===`M`){lf();let e=wf();Ff.hint(e?`♪ MUSIC ON`:`MUSIC OFF`,900)}}),document.querySelectorAll(`#menu .btn.mode`).forEach(e=>{e.addEventListener(`click`,()=>{Q.mode=e.dataset.mode,document.querySelectorAll(`#menu .btn.mode`).forEach(t=>t.classList.toggle(`selected`,t===e))})}),document.querySelectorAll(`#menu .btn[data-diff]`).forEach(e=>{e.addEventListener(`click`,()=>{lf(),Q.diff=Dd[e.dataset.diff],Qf()})}),document.getElementById(`btn-rematch`).addEventListener(`click`,()=>{Ff.hideGameOver(),Qf()}),document.getElementById(`btn-menu`).addEventListener(`click`,()=>{Ff.hideGameOver(),Ff.showScoreboard(!1),zf.clear(),Z.hide(),Q.state=`menu`,Ff.showMenu(!0)});function Zf(){let e=document.getElementById(`strobe-ok`);return!e||e.checked}function Qf(){Sf(),Ff.showMenu(!1),Ff.showScoreboard(!0),Y.configure({mode:Q.mode,scale:1}),Q.scores=Array(Y.seats).fill(0),Ff.buildScoreboard(Kf().names,Kf().colors),Ff.setScore(Q.scores),Jf(),Q.state=`point`,ep(600)}function $f(){let e=Q.scores.reduce((e,t)=>e+t,0);return Y.seats===2&&Q.scores[0]>=10&&Q.scores[1]>=10?e%2:Math.floor(e/2)%Y.seats}function ep(e=1700){clearTimeout(Q.pointPending),Q.pointPending=setTimeout(()=>{let e=Q.scores.reduce((e,t)=>e+t,0),t=zf.roll(e,{allowStrobe:Zf()}),n=t.includes(`giant`)?1.55:t.includes(`tiny`)?.55:1;Y.configure({mode:Q.mode,scale:n}),Id.rebuild(),zf.apply(t),Yf(),Ff.banner(zf.labels()),Q.server=$f(),Ff.setServer(Q.server),Q.lastHitter=-1,Q.legalBounce=!1,Q.rallyClock=0,Q.slowClock=0,$.cooldown=0;for(let e of Wf)e.cooldown=0,e.attempted=!1;Z.hide(),If.toneMappingExposure=1.05,Q.state=`serve`,Q.server===0?Ff.hint(`HOLD & RELEASE TO SERVE`):(Ff.hint(`${qf(Q.server)} SERVES…`,1200),Q.serveTimer=1.3)},e)}function tp(e,{power:t=.5,latFrac:n=null,miss:r=!1}={}){let i=(e+1)%Y.seats;if(r){let e=Y.seatDirs[i],t=Y.seatTans[i],n=Y.mode===`classic`?Y.halfL:Y.apothem,r=Math.random()<.5,a=r?n*(1.12+Math.random()*.25):n*(.5+Math.random()*.3),o=r?(Math.random()*2-1)*Y.edgeHalf*.5:(Math.random()<.5?-1:1)*Y.edgeHalf*(1.1+Math.random()*.3);return{x:e.x*a+t.x*o,y:J,z:e.y*a+t.y*o}}let a=n===null?(Math.random()*2-1)*.8:n;return Y.sectorTarget(i,t,a)}function np(e,t){Q.lastHitter=e,Q.legalBounce=!1,Q.rallyClock=0,Q.slowClock=0,e===0&&($.cooldown=Ed,$.swing=0);let n=(e+1)%Y.seats,r=Wf.find(e=>e.seat===n);if(r){let e=Q.diff;r.errA=(Math.random()*2-1)*e.botErr,r.errY=(Math.random()*2-1)*e.botErr*.6,r.reactClock=e.botReact,r.attempted=!1}let i=Wf.find(t=>t.seat===e);i&&(i.cooldown=Ed)}function rp(e){Ff.clearHint(),_p.set($.x,Math.max($.y,J+.25),Y.playerZ-.1);let t=af(_p,tp(0,{power:e,latFrac:Dt.clamp(-$.x*.5+(Math.random()-.5)*.6,-.85,.85)}),(3+e*3.4)*Y.speedScale);Z.spawn(_p,t),np(0,e),pf.paddleHit(e),Gf.kick=.4+e*.7,Q.state=`rally`}function ip(e){let t=Q.diff,n=dp(e,gp);_p.set(n.x,Math.max(n.y,J+.3),n.z),_p.addScaledVector(vp.set(e.dir.x,0,e.dir.y),-.1);let r=tp(e.seat,{power:.45+Math.random()*.2,miss:Math.random()<t.missProb*.5}),i=Dt.lerp(t.botPower[0],t.botPower[1],Math.random())*.85*Y.speedScale;Z.spawn(_p,af(_p,r,i)),np(e.seat,.5),pf.botHit(.5),e.swingAnim=1,Q.state=`rally`}function ap(e,t){if(Q.state!==`rally`)return;if(Q.state=`point`,Ff.hideBanner(),e===`replay`){Ff.message(t===`swallowed`?`SWALLOWED!`:`LET`,`replay the point`,1400),t===`swallowed`&&(pf.swallowed(),Z.hide()),ep(1500);return}Q.scores[e]++,e===0?pf.pointWin():pf.pointLose(),Ff.setScore(Q.scores),Gf.shake=Math.max(Gf.shake,.35);let n=[...Q.scores].sort((e,t)=>t-e),r=n[0]>=11&&n[0]-n[1]>=2,i=t;if(!r){if(Y.seats===2&&Q.scores[0]>=10&&Q.scores[0]===Q.scores[1])i=`DEUCE`;else for(let e=0;e<Y.seats;e++){let t=Q.scores.filter((t,n)=>n!==e);if(Q.scores[e]>=10&&Q.scores[e]-Math.max(...t)>=1){i=`GAME POINT — ${qf(e)}`;break}}}if(Ff.message(e===0?`YOU SCORE!`:`${qf(e)} SCORES`,i,1400),r){Q.state=`gameover`,zf.clear(),gf(),If.toneMappingExposure=1.05;let e=Q.scores.indexOf(Math.max(...Q.scores));e===0?pf.gameWin():pf.gameLose(),setTimeout(()=>Ff.showGameOver(e===0,e===0?`YOU WIN!`:`${qf(e)} WINS`,Q.scores.join(` — `)),1300)}else ep(1700)}var op={onBounceTable(e){if(pf.bounce(),Q.state!==`rally`||Q.lastHitter<0)return;let t=Q.lastHitter,n=(t+1)%Y.seats;e===n?Q.legalBounce?ap(t,`double bounce — ${qf(n)} never touched it`):Q.legalBounce=!0:ap(n,t===0?`your shot landed in the wrong zone`:`${qf(t)} hit the wrong zone`)},onNet(){pf.net()},onHole(e){if(Q.state!==`rally`){Z.hide();return}pf.sunk();let t=Q.lastHitter;if(t<0){ap(`replay`,`let`),Z.hide();return}let n=(t+1)%Y.seats;e===n?ap(t,t===0?`SUNK IT! unreturnable`:`${qf(t)} sank it in a hole`):ap(n,t===0?`you sank your own shot`:`${qf(t)} sank its own shot`),setTimeout(()=>Z.hide(),350)},onFloor(){sp()},onOut(){sp()}};function sp(){if(Q.state!==`rally`){Z.hide();return}let e=Q.lastHitter;if(e<0){ap(`replay`,`let`);return}let t=(e+1)%Y.seats;Q.legalBounce?ap(e,t===0?`you missed the return`:`${qf(t)} missed the return`):ap(t,e===0?`you missed the table`:`${qf(e)} missed the table`),Z.hide()}function cp(){return zf.flags.giantPaddle?1.8:1}function lp(){if($.cooldown>0||!Z.active||Q.state!==`rally`||Z.vel.z<=.2||!(Z.pos.z>Y.playerZ-.65&&Z.pos.z<Y.playerZ+.42))return;gp.set($.x,$.y,Y.playerZ);let e=Z.pos.distanceTo(gp);$.swing>0&&e<Q.diff.hitRadius*cp()?up($.swingPower):e<.22*cp()&&up(.12,!0)}function up(e,t=!1){let n=Dt.clamp($.vx*.22-$.x*.4+(Math.random()*2-1)*(t?.5:.2),-.95,.95),r=tp(0,{power:t?.25:e,latFrac:n}),i=(t?2.6:3.1+e*4.1)*Y.speedScale,a=af(Z.pos,r,i,t?.02:.07);Z.vel.copy(a),np(0,e),pf.paddleHit(e),Gf.kick=.3+e*1.1,Gf.shake=Math.max(Gf.shake,.06+e*.22)}function dp(e,t){let n=Y.robotDist;return t.set(e.dir.x*n+e.tan.x*e.along,e.y,e.dir.y*n+e.tan.y*e.along),t}function fp(e,t){let n=Q.diff;e.cooldown=Math.max(0,e.cooldown-t),Q.state===`serve`&&Q.server===e.seat&&(Q.serveTimer-=t,e.targetAlong=0,e.targetY=1.08,Q.serveTimer<=0&&ip(e));let r=(Q.lastHitter+1)%Y.seats,i=Z.vel.x*e.dir.x+Z.vel.z*e.dir.y;if(Q.state===`rally`&&Z.active&&Q.lastHitter>=0&&Q.lastHitter!==e.seat&&r===e.seat&&i>.1){if(e.reactClock-=t,e.reactClock<=0){let t=ef(Z.pos,Z.vel,e.dir,Y.robotDist-.1,zf.forceFn);if(t){let n=t.x*e.tan.x+t.z*e.tan.y;e.targetAlong=Dt.clamp(n+e.errA,-(Y.edgeHalf+.4),Y.edgeHalf+.4),e.targetY=Dt.clamp(t.y+e.errY,J+.05,1.9)}e.reactClock=Math.max(n.botReact*.6,.08)}let r=Z.pos.x*e.dir.x+Z.pos.z*e.dir.y;if(e.cooldown<=0&&!e.attempted&&r>=Y.robotDist-.15&&r<=Y.robotDist+.28){e.attempted=!0,dp(e,gp);let t=n.reach*Math.max(1,Y.scale*.85);if(Z.pos.distanceTo(gp)<t){let t=tp(e.seat,{power:.35+Math.random()*.5,miss:Math.random()<n.missProb}),r=Dt.lerp(n.botPower[0],n.botPower[1],Math.random())*Y.speedScale;Z.vel.copy(af(Z.pos,t,r,.07)),np(e.seat,.6),pf.botHit(.6),e.swingAnim=1}else e.swingAnim=1,pf.swish()}}else(Q.state===`rally`||Q.state===`serve`)&&(e.targetAlong=Z.active?Dt.clamp((Z.pos.x*e.tan.x+Z.pos.z*e.tan.y)*.15,-.5,.5):0,e.targetY=1.08);let a=Q.diff.botSpeed*Math.max(1,Y.scale*.8)*t,o=e.targetAlong-e.along,s=e.targetY-e.y,c=Math.hypot(o,s);if(c>1e-4){let t=Math.min(c,a);e.along+=o/c*t,e.y+=s/c*t}e.swingAnim=Math.max(0,e.swingAnim-t*4)}var pp=new Zs,mp=0,hp=1/240,gp=new H,_p=new H,vp=new H;function yp(e){for(let t of Wf)fp(t,e);if($.cooldown=Math.max(0,$.cooldown-e),$.swing=Math.max(0,$.swing-e),Z.active&&(Z.step(e,zf.forceFn,op),zf.collideBall(Z),lp(),Q.state===`rally`)){if(zf.checkCapture(Z)){ap(`replay`,`swallowed`);return}if(Q.rallyClock+=e,Q.rallyClock>10){ap(`replay`,`let`),Z.hide();return}if(!Z.sunk&&Z.vel.lengthSq()<.35&&Z.pos.y<J+.12){if(Q.slowClock+=e,Q.slowClock>.9){sp();return}}else Q.slowClock=0}}function bp(e,t){let n=zf.flags,r=26;n.snowSlip&&(r=9),n.drunk&&(r=Math.min(r,10));let i=1-Math.exp(-r*e),a=$.tx,o=$.ty;n.drunk&&(a+=Math.sin(t*1.1)*.3+Math.sin(t*2.3)*.12,o+=Math.cos(t*1.4)*.15);let s=$.x;$.x+=(a-$.x)*i,$.y+=(o-$.y)*i,$.vx=e>0?($.x-s)/e:0,$.charging?($.charge=Dt.clamp((performance.now()-$.chargeStart)/1e3/1,0,1),Ff.charge($.charge)):$.charge=0,$.scale+=((n.giantPaddle?2.1:1)-$.scale)*Math.min(1,e*6),Bf.scale.setScalar($.scale);let c=$.swing>0?1-$.swing/Td:1,l=$.swing>0?Math.sin(c*Math.PI)*.34:0,u=$.charge*.14;Bf.position.set($.x,$.y,Y.playerZ+u-l),Bf.rotation.set(-.35-$.charge*.55+($.swing>0?Math.sin(c*Math.PI)*.9:0),$.x*-.25+$.vx*.02,$.vx*-.03),Bf.userData.rubberMat.emissiveIntensity=$.charge*.5;for(let n of Wf){let r=n.swingAnim>0?Math.sin((1-n.swingAnim)*Math.PI)*.3:0;dp(n,gp),gp.addScaledVector(vp.set(n.dir.x,0,n.dir.y),-.02-r),n.paddle.position.copy(gp),n.paddle.rotation.set(.3+r*1.4,n.faceY+Math.PI+n.along*.15,0),n.avatarAlong+=(n.along*.85-n.avatarAlong)*(1-Math.exp(-8*e));let i=Y.robotDist+.45;n.avatar.position.set(n.dir.x*i+n.tan.x*n.avatarAlong,Math.sin(t*1.7+n.seat)*.025,n.dir.y*i+n.tan.y*n.avatarAlong),n.avatar.userData.visorMat.color.setHex(Q.state===`rally`?16724770:Vf[Q.mode].accent[n.seat])}Q.state===`serve`&&Q.server===0&&(Z.mesh.visible=!0,Z.mesh.position.set($.x,Math.max($.y,J+.25)+.02,Y.playerZ-.12)),zf.update(e),Gf.shake=Math.max(Gf.shake,zf.consumeShake());let d=zf.quake;d>0?(Gf.shake=Math.max(Gf.shake,d*.3),Id.group?.position.set((Math.random()-.5)*.03*d,(Math.random()-.5)*.02*d,0)):Id.group&&Id.group.position.set(0,0,0),If.toneMappingExposure=n.strobe&&(Q.state===`rally`||Q.state===`serve`)?t*2.4%1<.5?1.05:.45:1.05,If.domElement.style.filter=n.drunk?`blur(${(1.5+Math.sin(t*.9)).toFixed(2)}px) saturate(1.35)`:``,Gf.kick=Math.max(0,Gf.kick-e*4),Gf.shake=Math.max(0,Gf.shake-e*1.8);let f=Gf.shake*Gf.shake;Lf.position.set($.x*.34+(Math.random()-.5)*f*.12,Y.camY+($.y-1.15)*.28+(Math.random()-.5)*f*.1,Y.camZ+Gf.kick*.05);let p=Y.mode===`classic`?-Y.halfL*.85:-Y.apothem*.6;Lf.lookAt($.x*.15,J+.12,p),n.drunk&&(Lf.rotation.z+=Math.sin(t*.8)*.055);let m=Hf+Gf.kick*4;Math.abs(Lf.fov-m)>.01&&(Lf.fov+=(m-Lf.fov)*Math.min(1,e*10),Lf.updateProjectionMatrix()),If.render(Rf,Lf)}If.setAnimationLoop(()=>{let e=Math.min(pp.getDelta(),.05);mp+=e;let t=0;for(;mp>=hp&&t<20;)yp(hp),mp-=hp,t++;bp(e,pp.elapsedTime)}),Id.rebuild(),typeof window<`u`&&(window.__game={G:Q,world:Y,ball:Z,get bots(){return Wf}});